...
function setpaths()
{
    ...
    ANDROID_SELINUX_TOOLS=$T/external/selinux/prebuilts/bin
    export ANDROID_DEV_SCRIPTS=$T/development/scripts:$T/prebuilts/devtools/tools:$ANDROID_SELINUX_TOOLS
