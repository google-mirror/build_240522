...
# Start or finish a map or a list.
# 1: Parenthesis
# 2: Key name
json_open =$= $(eval _json_contents := $$(_json_contents)$$(_json_indent)$$(1)$$(newline))$(json_increase_indent)
json_open_key =$= $(eval _json_contents := $$(_json_contents)$$(_json_indent)"$$(strip $$(2))": $$(1)$$(newline))$(json_increase_indent)
json_close =$= $(json_decrease_indent)$(eval _json_contents := $$(_json_contents)$$(if $$(filter %$$(comma),$$(lastword $$(_json_contents))),__SV_END)$$(_json_indent)$$(1),$$(newline))
...
add_json_biglist =$= $(call json_open_key,[,$(1))
end_json_biglist =$= $(call json_close,])
add_json_csv =$= $(call add_json_val,$(1),$(call csv_to_json_list,$(strip $(2))))
add_json_bool =$= $(call add_json_val,$(1),$(if $(strip $(2)),true,false))
add_json_map =$= $(call json_open_key,{,$(1))
end_json_map =$= $(call json_close,})
add_json_struct =$= $(call json_open,{)
end_json_struct =$= $(call json_close,})
