...
# Remove ART artifacts installed by modules `art-runtime` and
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libbacktrace.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libbase.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libc++.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libcrypto.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libcutils.so)
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libicuuc.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libjdwp.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/liblog.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/liblzma.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libmetricslogger.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libnativebridge.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libnativehelper.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libnativeloader.so)
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libpagemap.so)
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libsigchain.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libstatssocket.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libtombstoned_client.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libunwindstack.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libutils.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libvixl.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libvixld.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libvndksupport.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libz.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/lib*/libziparchive.so)
