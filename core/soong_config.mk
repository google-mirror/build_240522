...
# TODO: Remove `$(COVERAGE_PATHS)` from this list when all users have been moved to
# `NATIVE_COVERAGE_PATHS`.
$(call add_json_list, NativeCoveragePaths,               $(COVERAGE_PATHS) $(NATIVE_COVERAGE_PATHS))
# TODO: Remove `$(COVERAGE_EXCLUDE_PATHS)` from this list when all users have been moved to
