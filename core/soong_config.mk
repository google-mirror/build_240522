...
ifeq (,$(TARGET_BUILD_UNBUNDLED))
  # Make the installed APEXes known to Soong. Filter out any .flattened suffix,
  # to match the .bp module names.
  $(call add_json_list, InstallApexes,                   $(patsubst %.flattened,%,$(PRODUCT_INSTALL_APEXES)))
else
