...
ifneq ($(USE_CCACHE),)
  ...
  ifdef CCACHE_BIN
    ...
    ifneq ($(CCACHE_BIN),$(firstword $($(combo_var_prefix)CC)))
      $(combo_var_prefix)CC := $(CCACHE_BIN) $($(combo_var_prefix)CC)
    endif
    ifneq ($(CCACHE_BIN),$(firstword $($(combo_var_prefix)CXX)))
      $(combo_var_prefix)CXX := $(CCACHE_BIN) $($(combo_var_prefix)CXX)
    endif
  endif
endif
