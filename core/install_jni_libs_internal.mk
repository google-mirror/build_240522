...
ifdef my_embed_jni
  ...
  ifeq ($(filter address,$(SANITIZE_TARGET)),)
    ...
    $(foreach pl_pair,$(partition_lib_pairs),\
      ...
      $(if $(call streq,$(call get-api-domain,$(partition_tag)),$(call get-api-domain,$(lib_partition))),,\
        $(call pretty-error, $(LOCAL_MODULE) and $(lib_name) do not share same API domain.))\
