...
ifdef LOCAL_DEX_PREOPT
  ...
  # include all packages (the full list in unknown until reading all Android.mk
  ...
  # to load dexpreopt code on device. Fix this, either by deferring dependency
  # computation until the full list of product packages is known, or by adding
  # product-specific lists of missing libraries.
