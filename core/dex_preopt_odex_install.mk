...
ifdef LOCAL_DEX_PREOPT
  ...
  # 2: list of libraries
  #
  # On-device path is set to /system/framowork/*.jar. For compatibility
  # libraries this is the correct default, and for other libraries this
  # will be patched by dex_preop_config_merger.py. Subcontexts likewise.
  #
  ...
  # the current module by Make (there's no tolological order), so the dependency
