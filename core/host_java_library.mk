...
full_classes_jacoco_jar := $(intermediates.COMMON)/classes-jacoco.jar
...
$(eval $(call copy-one-file,$(full_classes_jacoco_jar),$(LOCAL_BUILT_MODULE)))
$(eval $(call copy-one-file,$(full_classes_jacoco_jar),$(full_classes_jar)))
