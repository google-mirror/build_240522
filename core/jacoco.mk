...
# Unfortunately in the previous task above, 'rm -rf $(PRIVATE_JACOCO_EXCLUDE_ARGS)' needs to be a separate
...
$(LOCAL_FULL_CLASSES_JACOCO_JAR): $(my_jacoco_instrumented_timestamp_path) $(LOCAL_FULL_CLASSES_PRE_JACOCO_JAR)
  ...
  # this is used to trigger $(my_jacoco_classes_to_report_on_path) to build when $(LOCAL_FULL_CLASSES_JACOCO_JAR) builds, but it isn't truly a dependency.
