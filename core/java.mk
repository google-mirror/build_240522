...
ifneq ($(filter current system_current test_current core_current, $(LOCAL_SDK_VERSION)$(TARGET_BUILD_USE_PREBUILT_SDK)),)
  # LOCAL_SDK_VERSION is current and no TARGET_BUILD_USE_PREBUILT_SDK
