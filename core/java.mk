...
$(full_classes_jack): $(jack_all_deps) | start-jack-server
...
$(built_dex_intermediate): $(jack_all_deps) | start-jack-server
	@echo Building with Jack: $@
	$(jack-java-to-dex)
...
$(noshrob_classes_jack): $(jack_all_deps) | start-jack-server
	@echo Building with Jack: $@
	$(java-to-jack)
endif  # full_classes_jar is defined
