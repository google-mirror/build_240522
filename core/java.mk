...
jack_all_deps := $(java_source_list_file) $(full_jack_deps) \
        $(jar_manifest_file) $(layers_file) $(common_proguard_flag_files) \
        $(proguard_flag_files) $(annotation_processor_deps) \
