...
ifeq ($(LOCAL_EMMA_INSTRUMENT),true)
  # TODO to be replaced with jacocoagent.jar
  jack_all_deps += $(EMMA_JAR)

$(built_dex_intermediate): PRIVATE_JACK_COVERAGE_OPTIONS := -D jack.coverage="true"
$(built_dex_intermediate): PRIVATE_JACK_COVERAGE_OPTIONS += -D jack.coverage.metadata.file=$(intermediates.COMMON)/coverage.em
$(built_dex_intermediate): PRIVATE_JACK_COVERAGE_OPTIONS += -D jack.coverage.jacoco.package=org.jacoco.agent.rt.internal_b0d6a23
else
