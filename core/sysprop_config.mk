...
ADDITIONAL_SYSTEM_PROPERITES := $(strip $(ADDITIONAL_SYSTEM_PROPERTIES))
ADDITIONAL_PRODUCT_PROPERITES := $(strip $(ADDITIONAL_PRODUCT_PROPERTIES))
ADDITIONAL_VENDOR_PROPERITES := $(strip $(ADDITIONAL_VENDOR_PROPERTIES))
