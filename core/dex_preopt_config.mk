...
$(call add_json_bool, DisableGenerateProfile,             $(call invert_bool,$(filter false,$(WITH_DEX_PREOPT_GENERATE_PROFILE))))
...
$(call add_json_bool, NoDebugInfo,                        $(call invert_bool,$(filter false,$(WITH_DEXPREOPT_DEBUG_INFO))))
$(call add_json_bool, AlwaysSystemServerDebugInfo,        $(filter true,$(PRODUCT_SYSTEM_SERVER_DEBUG_INFO)))
$(call add_json_bool, NeverSystemServerDebugInfo,         $(call invert_bool,$(filter false,$(PRODUCT_SYSTEM_SERVER_DEBUG_INFO))))
$(call add_json_bool, AlwaysOtherDebugInfo,               $(filter true,$(PRODUCT_OTHER_JAVA_DEBUG_INFO)))
$(call add_json_bool, NeverOtherDebugInfo,                $(call invert_bool,$(filter false,$(PRODUCT_OTHER_JAVA_DEBUG_INFO))))
