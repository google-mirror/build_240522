...
ifeq (,$(filter ETC EXECUTABLES NATIVE_TESTS SCRIPT SHARED_LIBRARIES STATIC_LIBRARIES,$(LOCAL_MODULE_CLASS)))
  $(call pretty-error,Unexpected LOCAL_MODULE_CLASS for cc_prebuilt_internal.mk)
endif
