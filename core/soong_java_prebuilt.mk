...
ifdef LOCAL_SOONG_PROGUARD_DICT
  ...
  $(eval ALL_TARGETS.$(call local-packaging-dir,proguard_dictionary)/proguard_dictionary.META_LIC := $(LOCAL_SOONG_LICENSE_METADATA))
  $(eval $(call copy-one-file,$(LOCAL_SOONG_CLASSES_JAR),\
    $(call local-packaging-dir,proguard_dictionary)/classes.jar))
  $(eval ALL_TARGETS.$(call local-packaging-dir,proguard_dictionary)/classes.jar.META_LIC := $(LOCAL_SOONG_LICENSE_METADATA))
  $(call add-dependency,$(common_javalib.jar),\
    $(intermediates.COMMON)/proguard_dictionary)
  $(call add-dependency,$(common_javalib.jar),\
    $(call local-packaging-dir,proguard_dictionary)/proguard_dictionary)
