...
# These keys are no longer used. The MODULE_LICENSE_* files have been replaced
# by METADATA license_type, which only resolves to broad classes of licenses.
$(KATI_obsolete_var ALL_DEPS.$(LOCAL_MODULE).LICENSE)
endif
