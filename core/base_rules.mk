...
ifeq (,$(test_config))
  ...
  # Only allow auto-generating test config files if the module belongs to
  # device-tests or general-tests suite.
  ifeq (,$(filter-out device-tests general-tests,$(LOCAL_COMPATIBILITY_SUITE)))
