...
###########################################################
## Define Support varient.
###########################################################
my_support_varient :=
ifdef LOCAL_IS_HOST_MODULE
  my_support_varient := HOST
else
  my_support_varient := DEVICE
endif
...
ALL_MODULES.$(my_register_name).SUPPORT_VARIENTS := \
  $(ALL_MODULES.$(my_register_name).SUPPORT_VARIENTS) \
  $(filter-out $(ALL_MODULES.$(my_register_name).SUPPORT_VARIENTS),$(my_support_varient))
