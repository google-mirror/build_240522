...
else ifneq ($(filter $(TARGET_OUT_PRODUCTSERVICES)/%,$(_path)),)
LOCAL_PRODUCTSERVICES_MODULE := true
endif
_path :=
...
else ifeq (true,$(LOCAL_PRODUCTSERVICES_MODULE))
  partition_tag := _PRODUCTSERVICES
