...
testcase_out_dirs := $(call get-testcase-out-dirs, \
...
# The module itself.
my_compat_dist := $(foreach dir, $(testcase_out_dirs),\
...
$(foreach suite, $(LOCAL_COMPATIBILITY_SUITE), \
  $(eval COMPATIBILITY.$(suite).FILES := \
    $(COMPATIBILITY.$(suite).FILES) $(my_compat_files)))
