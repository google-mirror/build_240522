...
ifdef LOCAL_IS_HOST_MODULE
  ...
  ifeq ($(LOCAL_HOST_PREFIX),HOST_)
    my_prefix := HOST_
  endif
  ifeq ($(LOCAL_HOST_PREFIX),HOST_CROSS_)
    my_prefix := HOST_CROSS_
  endif
  ifeq ($(my_prefix),)
    $(error Unknown $(LOCAL_HOST_PREFIX))
  endif
  my_host := host-
else
  my_prefix := TARGET_
...
ifdef LOCAL_IS_HOST_MODULE
my_required_modules += $(LOCAL_REQUIRED_MODULES_$($(my_prefix)_OS))
endif
