...
$(link_type).DEPS := $(foreach lib,$(LOCAL_STATIC_JAVA_LIBRARIES),$(my_link_prefix)$(comma)JAVA_LIBRARIES$(comma)$(lib))
$(link_type).DEPS += $(foreach lib,$(apk_libraries),$(my_link_prefix)$(comma)APPS$(comma)$(lib))
