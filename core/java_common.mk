...
ifeq (,$(LOCAL_JAVA_LANGUAGE_VERSION))
  ...
  else ifneq (,$(LOCAL_SDK_VERSION)$(filter true,$(TARGET_BUILD_USE_PREBUILT_SDKS)))
...
ifndef LOCAL_IS_HOST_MODULE
  ...
  ifeq ($(LOCAL_SDK_VERSION),)
    ...
    ifneq (,$(filter true,$(TARGET_BUILD_USE_PREBUILT_SDKS))$(filter-out %current,$(LOCAL_SDK_VERSION)))
