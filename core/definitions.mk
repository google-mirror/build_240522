...
@mkdir -p $(dir $@)
$(hide) rm -f $@ $@.tmp
@rm -rf $(realpath $(dir $@))$(realpath $(dir $@))/desugar_dumped_classes
@mkdir $(realpath $(dir $@))/desugar_dumped_classes
$(hide) java \
    -Djdk.internal.lambda.dumpProxyClasses=$(realpath $(dir $@))/desugar_dumped_classes \
    -jar $(DESUGAR) \
