...
# Relative paths to installed notice files for modules whose rule has
# not been emitted.
...
# Emit each installed notice file rule if it has not already been emitted.
$(if $(_infs),$(foreach inf,$(_infs),
$(if $(filter $(inf),$(ALL_INSTALLED_NOTICE_FILES)),
...
$(strip $(eval ALL_INSTALLED_NOTICE_FILES := $(filter-out $(inf),$(ALL_INSTALLED_NOTICE_FILES))))
)))
