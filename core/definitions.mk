...
## However, bionic/linker uses -dynamic to overwrite.
## Linker for x86 targets does not allow coexistance of -static and -dynamic,
...
$(hide) $(PRIVATE_CXX) \
	-nostdlib -Bstatic \
	$(if $(findstring -shared,"$(PRIVATE_LDFLAGS)"),,-static) \
	-Wl,--gc-sections \
	-o $@ \
	$(PRIVATE_TARGET_GLOBAL_LD_DIRS) \
