...
$(hide) if [ -s $@.premerged ] ; then \
    $(MERGE_ZIPS) -j -strip META-INF/TRANSITIVE $@.tmp $@.premerged $(PRIVATE_STATIC_JAVA_HEADER_LIBRARIES) ; \
else \
    $(MERGE_ZIPS) -j -strip META-INF/TRANSITIVE $@.tmp $(PRIVATE_STATIC_JAVA_HEADER_LIBRARIES) ; \
fi
$(hide) $(ZIPTIME) $@.tmp
