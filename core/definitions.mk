...
$(strip \
  $(if $(call streq,0,$(words $(1))),$(error Argument missing to math function)) \
  $(if $(call streq,1,$(words $(1))),,$(error Multiple words in a single argument to a math function: $(1))) \
  $(if $(call streq,$(1),$(filter $(1),$(__MATH_NUMBERS))),,$(error Only positive integers <= 100 are supported (not $(1)))))
endef
...
$(call streq,$(1),$(filter $(1),$(__MATH_NUMBERS)))
endef

#$(warning true == $(call math_is_number,2))
#$(warning == $(call math_is_number,foo))
#$(warning true == $(call math_is_number,1 2))
