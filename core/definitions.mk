...
$(2): $(1) $(HIDDENAPI) \
	...
	rm -rf `dirname $(2)`; \
	mkdir `dirname $(2)`; \
	find `dirname $(1)` -maxdepth 1 -name "classes*.dex" | xargs -I{} cp -f {} `dirname $(2)`/; \
	find `dirname $(2)` -maxdepth 1 -name "classes*.dex" | sort | sed 's/^/--boot-dex=/' \
...
$(INTERNAL_PLATFORM_HIDDENAPI_PRIVATE_LIST): PRIVATE_DEX_INPUTS += $(1)
endef
