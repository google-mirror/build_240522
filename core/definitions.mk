...
$(if $(findstring $(TARGET_OUT), $(PRIVATE_PATH)), \
  $(if $(findstring hardware/, $(PRIVATE_MAKEFILE)), \
    $(warning $(PRIVATE_MAKEFILE): Warning: device specific binary $(PRIVATE_MODULE) is getting installed to system location $(PRIVATE_PATH)), \
  ), \
)
$(hide) touch $@
endef
