...
###########################################################
## Generate warning or error message with the make
...
define log-warning
$(eval \
$(shell echo $(LOCAL_MODULE_MAKEFILE):$(LOCAL_MODULE): warning: $(1) >&2) \
...
define log-error
$(eval \
$(shell echo $(LOCAL_MODULE_MAKEFILE):$(LOCAL_MODULE): error: $(1) >&2) \
