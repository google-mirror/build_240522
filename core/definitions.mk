...
###########################################################
## Rules to compile a single C/C++ source with ../ in the parth
###########################################################
...
o := $(intermediates)/$(patsubst %$(LOCAL_CPP_EXTENSION),%.o,$(subst ../,,$(1)))
...
o := $(intermediates)/$(patsubst %.c,%.o,$(subst ../,,$(1)))
$$(o) : $(TOPDIR)$(LOCAL_PATH)/$(1) $(2)
...
o := $(intermediates)/$(patsubst %.S,%.o,$(subst ../,,$(1)))
$$(o) : $(TOPDIR)$(LOCAL_PATH)/$(1) $(2)
