...
$(hide) $(JAVA) \
    ...
    $(addprefix --bootclasspath_entry ,$(filter $(TARGET_DEFAULT_JAVA_LIBRARIES),$(PRIVATE_SHARED_JAVA_HEADER_LIBRARIES))) \
    $(addprefix --classpath_entry ,$(filter-out $(TARGET_DEFAULT_JAVA_LIBRARIES),$(PRIVATE_SHARED_JAVA_HEADER_LIBRARIES))) \
