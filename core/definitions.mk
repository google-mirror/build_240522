...
$(if $(filter hello_world_test StsCommonUtilTests ats-tradefed-tests,$(my_register_name)),,$(eval LOCAL_COMPATIBILITY_SUITE := $(filter-out general-tests,$(LOCAL_COMPATIBILITY_SUITE)))) \
