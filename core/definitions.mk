...
$(hide) $(PRIVATE_OBJCOPY) --only-keep-debug $< $@.mini_debuginfo
$(hide) $(PRIVATE_OBJCOPY) -O binary --only-section=.debug_frame --set-section-flags .debug_frame=alloc $@.mini_debuginfo $@.debug_frame
$(hide) $(PRIVATE_OBJCOPY) -S --remove-section .gdb_index --remove-section .comment --keep-symbols=$@.keep_symbols $@.mini_debuginfo
$(hide) $(PRIVATE_OBJCOPY) --add-section .debug_frame=$@.debug_frame $@.mini_debuginfo
...
$(hide) rm -f $@.dynsyms $@.funcsyms $@.keep_symbols $@.debug $@.mini_debuginfo.xz $@.debug_frame
endef
