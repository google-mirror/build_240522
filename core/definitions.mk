...
$(full_classes_compiled_jar).shard.$(1): PRIVATE_JAVACFLAGS := $(LOCAL_JAVACFLAGS) $(annotation_processor_flags)
$(full_classes_compiled_jar).shard.$(1): PRIVATE_JAR_EXCLUDE_FILES := $(LOCAL_JAR_EXCLUDE_FILES)
$(full_classes_compiled_jar).shard.$(1): PRIVATE_JAR_PACKAGES := $(LOCAL_JAR_PACKAGES)
$(full_classes_compiled_jar).shard.$(1): PRIVATE_JAR_EXCLUDE_PACKAGES := $(LOCAL_JAR_EXCLUDE_PACKAGES)
$(full_classes_compiled_jar).shard.$(1): PRIVATE_DONT_DELETE_JAR_META_INF := $(LOCAL_DONT_DELETE_JAR_META_INF)
$(full_classes_compiled_jar).shard.$(1): PRIVATE_ALL_JAVA_HEADER_LIBRARIES := $(2)
$(full_classes_compiled_jar).shard.$(1): PRIVATE_CLASS_INTERMEDIATES_DIR := $(intermediates.COMMON)/classes_$(1)
$(full_classes_compiled_jar).shard.$(1): PRIVATE_ANNO_INTERMEDIATES_DIR := $(intermediates.COMMON)/anno_$(1)
$(full_classes_compiled_jar).shard.$(1): \
    $(java_source_list_file).shard.$(1) \
    $(2) \
