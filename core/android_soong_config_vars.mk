...
$(call add_soong_config_var,ANDROID,BOARD_MIXED_SEPOLICY)
ifneq (,$(BOARD_MIXED_SEPOLICY_VERSION))
$(call add_soong_config_var,ANDROID,BOARD_MIXED_SEPOLICY_VERSION)
endif
