...
# prefixed with "<apex>:", which identifies the APEX that provides it. Defaults
# to "platform:" if left out, i.e. part of the platform image. APEXes are
# identified by their "variant" names, i.e. their apex_name values, or their
# names if left out. See the long comment in
# build/soong/java/dexprepopt_bootjars.go for details.
