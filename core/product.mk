...
# Specifies maximum bytes to be compressed at once during ota. Options: 4k, 8k, 16k, 32k, 64k, 128k, 256k.
# Note, these are not literal values. PRODUCT_VIRTUAL_AB_COMPRESSION_FACTOR should be set as the integer equivalent of those options
# E.G. 4k -> 4096
