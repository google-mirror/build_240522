...
# "installable" properties in Soong. The names match those of `apex` modules in
# .bp files, except a ".flattened" may be added to specifically choose the
# flattened variant for the product.
