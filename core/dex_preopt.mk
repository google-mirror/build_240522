...
# We can do this only if preopt is enabled and if we inherit the runtime libart config (which sets the
# default properties for preopting).
ifeq ($(WITH_DEXPREOPT), true)
ifeq ($(PRODUCT_INHERIT_RUNTIME_LIBART), true)
...
endif  #PRODUCT_INHERIT_RUNTIME_LIBART
