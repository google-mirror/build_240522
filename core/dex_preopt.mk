...
art_release_zip_boot_jars=$(foreach f,$(ART_APEX_JARS),$(call word-colon,2,$(f)))
...
$(art_release_zip): $(SOONG_ZIP) $(MERGE_ZIPS) $(art_release_zip_boot_jars_files) out/soong/mainline-sdks/art-module-host-exports-current.zip
	@echo "Create ART release package: $@"
	rm -f $@
	$(SOONG_ZIP) -o $@.tmp \
	  -P bootjars -j $(addprefix -f ,$(PRIVATE_BOOT_JARS_FILES))
	$(MERGE_ZIPS) $@ $@.tmp out/soong/mainline-sdks/art-module-host-exports-current.zip
	rm -f $@.tmp
