...
$(INTERNAL_PLATFORM_HIDDENAPI_PRIVATE_LIST): $(HIDDENAPI) $(HIDDENAPI_STUBS)
	for INPUT_DEX in $(PRIVATE_DEX_INPUTS); do \
	    ...
	    --stub-classpath=$(subst $(space),$(colon),$(PRIVATE_HIDDENAPI_STUBS)) \
	    --stub-classpath=$(subst $(space),$(colon),$(PRIVATE_HIDDENAPI_STUBS_SYSTEM)) \
	    --stub-classpath=$(subst $(space),$(colon),$(PRIVATE_HIDDENAPI_STUBS_TEST)) \
