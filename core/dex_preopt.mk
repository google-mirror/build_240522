...
# Add system server JARs with "platform:" prefix to "/system" partition.
# These JARs counterintuitively use "platform" prefix but they will
# be installed to /system partition.
...
# Add the remaining system server JARs to the partition signified by the prefix.
