...
# this variable has a _for_zip suffix to prevent collisions with a previous variable name
platform_system_server_jars_for_zip := \
...
$(system_server_zip): PRIVATE_SYSTEM_SERVER_JARS := $(platform_system_server_jars_for_zip)
