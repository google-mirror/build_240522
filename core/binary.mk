...
dbus_headers := $(patsubst %.dbus.xml,%.h,$(dbus_if_sources))
endif
...
$(dbus_generated_headers) : $(dbus_service_config_full_path) $(DBUS_GENERATOR)
ifdef LOCAL_DBUS_PROXY_PREFIX
$(dbus_generated_headers) : $(dbus_if_sources_full_path)
...
my_c_includes += $(dir $(dbus_generated_headers))
