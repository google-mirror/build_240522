...
ifeq ($(CLANG_COVERAGE),true)
  ...
  ifeq ($(my_clang_coverage),true)
    ...
    my_cflags += $(my_profile_instr_generate) -fcoverage-mapping -Wno-pass-failed -D__ANDROID_CLANG_COVERAGE__ -Wno-frame-larger-than=
    my_ldflags += $(my_profile_instr_generate) -fcoverage-mapping
