...
ifeq ($(CLANG_COVERAGE),true)
  ...
  ifeq ($(my_clang_coverage),true)
    ...
    ifeq ($(CLANG_COVERAGE_CONTINUOUS_MODE),true)
      ...
      my_profile_instr_generate := $(CLANG_COVERAGE_CONTINUOUS_INSTR_PROFILE)
    endif

    my_profile_instr_generate += $(CLANG_COVERAGE_CONFIG_LDFLAGS)
    my_cflags += $(CLANG_COVERAGE_INSTR_PROFILE) $(CLANG_COVERAGE_CONFIG_CFLAGS)
    my_ldflags += $(CLANG_COVERAGE_CONFIG_LDFLAGS)
