...
# TODO: Remove `$(COVERAGE_PATHS)` from this condition when all users have been moved to
# `NATIVE_COVERAGE_PATHS`.
ifneq (,$(strip $(foreach dir,$(COVERAGE_PATHS) $(NATIVE_COVERAGE_PATHS),$(filter $(dir)%,$(LOCAL_PATH)))))
# TODO: Remove `$(COVERAGE_EXCLUDE_PATHS)` from this condition when all users have been moved to
