...
# Clang does not recognize all gcc flags, so skip static analyzer
# when gcc is specified.
ifneq ($(my_clang),true)
  LOCAL_NO_STATIC_ANALYZER := true
  LOCAL_NO_SYNTAX_CHECK := true
endif
...
ifneq ($(LOCAL_NO_STATIC_ANALYZER),true)
  my_cc := $(SYNTAX_TOOLS_PREFIX)/ccc-analyzer
else
ifneq ($(LOCAL_NO_SYNTAX_CHECK),true)
  my_cc := $(SYNTAX_TOOLS_PREFIX)/ccc-analyzer -fsyntax-only
endif
endif
...
ifeq ($(my_clang),true)
  export CCC_CXX=$(CLANG_CXX)
endif

ifneq ($(LOCAL_NO_STATIC_ANALYZER),true)
  my_cxx := $(SYNTAX_TOOLS_PREFIX)/c++-analyzer
else
ifneq ($(LOCAL_NO_SYNTAX_CHECK),true)
  my_cxx := $(SYNTAX_TOOLS_PREFIX)/c++-analyzer -fsyntax-only
endif
endif
