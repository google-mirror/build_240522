...
my_target_global_cppflags := $($(LOCAL_2ND_ARCH_VAR_PREFIX)CLANG_$(my_prefix)GLOBAL_CPPFLAGS) $(my_cpp_std_cppflags)
  ...
  ifeq ($(my_use_clang_lld),true)
    $(warning $(LOCAL_MODULE) in $(LOCAL_MODULE_MAKEFILE): USE_CLANG_LLD, $(LOCAL_USE_CLANG_LLD), $(USE_CLANG_LLD))
    my_target_global_ldflags := $($(LOCAL_2ND_ARCH_VAR_PREFIX)CLANG_$(my_prefix)GLOBAL_LLDFLAGS)
  else
    $(warning $(LOCAL_MODULE) in $(LOCAL_MODULE_MAKEFILE): NOT USE_CLANG_LLD, $(LOCAL_USE_CLANG_LLD), $(USE_CLANG_LLD))
