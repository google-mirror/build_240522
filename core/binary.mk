...
else ifeq ($(LOCAL_C_STD),bleeding-edge)
    my_c_std_version := $(BLEEDING_EDGE_C_STD_VERSION)
else
...
else ifeq ($(LOCAL_CPP_STD),bleeding-edge)
    my_cpp_std_version := $(BLEEDING_EDGE_CPP_STD_VERSION)
else
