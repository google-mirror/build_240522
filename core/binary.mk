...
# Any vendor module should not get abi stability checks.
ifeq ($(LOCAL_PROPRIETARY_MODULE),true)
  my_create_source_abi_dump := false
endif
# Only shared and static libraries should get abi stability checks.
...
$(LOCAL_INTERMEDIATE_TARGETS): PRIVATE_HEADER_ABI_DUMPER_ADDITIONAL_FLAGS := -w
