...
dbus_proxy_header := $(dbus_created_dir)/dbus-proxies.h
dbus_generated_headers := $(dbus_proxy_header)
else
dbus_created_dir := $(dbus_header_prefix)
dbus_adaptor_headers := $(patsubst %.dbus.xml,%.h,$(notdir $(dbus_if_sources)))
dbus_generated_headers := $(addprefix $(dbus_created_dir),$(dbus_adaptor_headers))
...
$(dbus_generated_headers) : PRIVATE_DBUS_CREATED_DIR := $(dbus_created_dir)
...
ifdef LOCAL_DBUS_PROXY_PREFIX
$(dbus_generated_headers) : PRIVATE_DBUS_PROXY_HEADER := $(dbus_proxy_header)
$(dbus_generated_headers) : $(dbus_generated_source_dependencies)
