...
ifeq ($(filter $(LOCAL_MODULE_CLASS), SHARED_LIBRARIES STATIC_LIBRARIES),)
  my_create_source_abi_dump := false
endif
# Only non libraries on the system image should get abi stability checks.
ifneq ($(LOCAL_PROPRIETARY_MODULE),)
  my_create_source_abi_dump := false
endif
# Only vndk-core eligible libraries should get abi stability checks.
ifeq ($(filter $(LOCAL_MODULE), $(VNDK_ELIGIBLE_LIBRARIES)),)
  my_create_source_abi_dump := false
endif
ifneq ($(my_clang), true)
  my_create_source_abi_dump := false
...
c_sdump_objects := $(c_normal_sdump_objects) $(c_arm_sdump_objects)
...
cpp_sdump_objects := $(cpp_normal_sdump_objects) $(cpp_arm_sdump_objects)
$(cpp_sdump_objects): $(HOST_OUT_EXECUTABLES)/header-abi-dumper
...
# TODO: Find the right tool / path to do this.
