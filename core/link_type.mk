...
#   my_link_check_class: class name of link type check, for separating each type of check
#
...
my_link_postfix := $(if $(my_link_check_class),$(my_link_check_class),_)
link_type := $(my_link_prefix):$(LOCAL_MODULE_CLASS):$(LOCAL_MODULE):$(my_link_postfix)
...
$(link_type).DEPS := $(addsuffix :$(my_link_postfix),$(addprefix $(my_link_prefix):,$(my_link_deps)))
