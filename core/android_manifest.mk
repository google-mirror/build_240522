...
ifdef LOCAL_PREFER_INTEGRITY
ifeq ($(LOCAL_PREFER_INTEGRITY),true)
    my_manifest_fixer_flags += --prefer-integrity=true
else
    my_manifest_fixer_flags += --prefer-integrity=false
endif
endif
