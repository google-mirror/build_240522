...
ifdef TARGET_BUILD_APPS
  ifndef TARGET_BUILD_APPS_USE_PREBUILT_SDK
    ifeq ($(my_target_sdk_version),$(PLATFORM_VERSION_CODENAME))
      ifdef UNBUNDLED_BUILD_TARGET_SDK_WITH_SHA256
        my_target_sdk_version := $(my_target_sdk_version).$$(cat $(CURRENT_TXT_SHA256))
        $(fixed_android_manifest): $(CURRENT_TXT_SHA256)
      endif
    endif
  endif
endif
