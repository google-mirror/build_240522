...
ALL_MODULES.$(my_register_name).MODULE_INSTALLED_FILENAME := $(ALL_MODULES.$(my_register_name).MODULE_INSTALLED_FILENAME) $(module_installed_filename)
ALL_MODULE_INSTALLED_FILENAMES += $(module_installed_filename)
else
