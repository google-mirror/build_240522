...
ifeq (,$(LOCAL_MODULE_TYPE))
LOCAL_MODULE_TYPE:=unknown
endif
...
ifeq ($(LOCAL_IS_HOST_MODULE),true)
notice_deps := $(strip $(notice_deps) $(foreach d,$(LOCAL_HOST_REQUIRED_MODULES),$(d):static))
else
notice_deps := $(strip $(notice_deps) $(foreach d,$(LOCAL_TARGET_REQUIRED_MODULES),$(d):static))
endif
