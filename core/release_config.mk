...
flag_declaration_files := build/make/release/flags.bzl \
    $(if $(wildcard vendor/google/release/flags.bzl), \
        vendor/google/release/flags.bzl, \
        $(sort \
            $(wildcard device/*/release/flags.bzl) \
            $(wildcard device/*/*/release/flags.bzl) \
            $(wildcard vendor/*/release/flags.bzl) \
            $(wildcard vendor/*/*/release/flags.bzl) \
        ) \
    )
config_map_files := build/make/release/release_config_map.bzl \
