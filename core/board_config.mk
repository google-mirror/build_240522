...
# TARGET_MULTI_ARCH is a setting specifically for config+soong-only builds, that are
# otherwise not dependent on TARGET_ARCH.
ifneq (,$(and $(TARGET_ARCH),$(TARGET_MULTI_ARCH)))
  $(error $(board_config_mk) erroneously sets both TARGET_ARCH and TARGET_MULTI_ARCH)
endif
ifeq ($(TARGET_ARCH)$(TARGET_MULTI_ARCH),)
  $(error TARGET_ARCH not defined by board config: $(board_config_mk))
endif
ifeq ($(TARGET_CPU_ABI)$(TARGET_MULTI_ARCH),)
