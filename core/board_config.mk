...
ifneq (,$(strip $(TARGET_RECOVERY_UPDATER_LIBS)$(TARGET_RECOVERY_UPDATER_EXTRA_LIBS)))
$(warning $(TARGET_RECOVERY_UPDATER_LIBS))
$(warning $(TARGET_RECOVERY_UPDATER_EXTRA_LIBS))
$(error done)
endif
