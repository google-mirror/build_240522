...
_board_strip_readonly_list += BOARD_DTBOIMG_PARTITION_SIZE
_board_strip_readonly_list += BOARD_AVB_DTBO_KEY_PATH
_board_strip_readonly_list += BOARD_AVB_DTBO_ALGORITHM
_board_strip_readonly_list += BOARD_AVB_DTBO_ROLLBACK_INDEX_LOCATION
_board_strip_readonly_list += BOARD_AVB_PVMFW_KEY_PATH
_board_strip_readonly_list += BOARD_AVB_PVMFW_ALGORITHM
_board_strip_readonly_list += BOARD_AVB_PVMFW_ROLLBACK_INDEX_LOCATION
_board_strip_readonly_list += BOARD_PARTIAL_OTA_UPDATE_PARTITIONS_LIST
_board_strip_readonly_list += BOARD_BPT_DISK_SIZE
_board_strip_readonly_list += BOARD_BPT_INPUT_FILES
_board_strip_readonly_list += BOARD_BPT_MAKE_TABLE_ARGS
_board_strip_readonly_list += BOARD_AVB_VBMETA_VENDOR_ROLLBACK_INDEX_LOCATION
_board_strip_readonly_list += BOARD_AVB_VBMETA_VENDOR_ALGORITHM
_board_strip_readonly_list += BOARD_AVB_VBMETA_VENDOR_KEY_PATH
_board_strip_readonly_list += BOARD_AVB_VBMETA_VENDOR
_board_strip_readonly_list += BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX_LOCATION
_board_strip_readonly_list += BOARD_AVB_VBMETA_SYSTEM_ALGORITHM
_board_strip_readonly_list += BOARD_AVB_VBMETA_SYSTEM_KEY_PATH
_board_strip_readonly_list += BOARD_AVB_VBMETA_SYSTEM
_board_strip_readonly_list += BOARD_AVB_RECOVERY_KEY_PATH
_board_strip_readonly_list += BOARD_AVB_RECOVERY_ALGORITHM
_board_strip_readonly_list += BOARD_AVB_RECOVERY_ROLLBACK_INDEX_LOCATION
_board_strip_readonly_list += BOARD_AVB_VENDOR_BOOT_KEY_PATH
_board_strip_readonly_list += BOARD_AVB_VENDOR_BOOT_ALGORITHM
_board_strip_readonly_list += BOARD_AVB_VENDOR_BOOT_ROLLBACK_INDEX_LOCATION
_board_strip_readonly_list += BOARD_GKI_SIGNING_SIGNATURE_ARGS
_board_strip_readonly_list += BOARD_GKI_SIGNING_ALGORITHM
_board_strip_readonly_list += BOARD_GKI_SIGNING_KEY_PATH
_board_strip_readonly_list += BOARD_MKBOOTIMG_ARGS
_board_strip_readonly_list += BOARD_VENDOR_BOOTIMAGE_PARTITION_SIZE
