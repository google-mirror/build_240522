...
TARGET_COPY_OUT_SYSTEM_EXT := system/ext
else ifeq ($(filter system_ext system/ext,$(TARGET_COPY_OUT_SYSTEM_EXT)),)
$(error TARGET_COPY_OUT_SYSTEM_EXT must be either 'system_ext' or 'system/ext', seeing '$(TARGET_COPY_OUT_SYSTEM_EXT)'.)
endif
