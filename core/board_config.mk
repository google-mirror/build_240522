...
ifeq ($(PRODUCT_BUILD_SYSTEM_DLKM_IMAGE),)
  ifdef BOARD_PREBUILT_SYSTEM_DLKM_IMAGE
    BUILDING_SYSTEM_DLKM_IMAGE :=
  else ifdef BOARD_USES_SYSTEM_DLKM_PARTITION
...
ifeq ($(BUILDING_SYSTEM_DLKM_IMAGE),true)
  ifdef BOARD_SYSTEM_DLKM_PARTITION_SIZE
    ...
    # Make sure we know the partition size
    $(error BOARD_SYSTEM_DLKM_PARTITION_SIZE is not defined; and required to build system_dlkm.img.)
  endif
endif
