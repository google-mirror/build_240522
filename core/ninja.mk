...
kati.intermediate: $(KATI)
	...
	$(hide) $(KATI) --ninja --ninja_dir=$(PRODUCT_OUT) --regen --ignore_optional_include=$(OUT_DIR)/%.P --ignore_dirty=$(OUT_DIR)/% --detect_android_echo --use_find_emulator -f build/core/main.mk $(ANDROID_TARGETS) USE_NINJA=false
