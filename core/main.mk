...
# EMMA_INSTRUMENT_STATIC merges the static jacoco library to each jacoco-enabled module.
ifeq (true,$(EMMA_INSTRUMENT_STATIC))
EMMA_INSTRUMENT := true
endif

ifeq (true,$(EMMA_INSTRUMENT))
#Adding the jacoco library can cause the inclusion of some typically banned classes
