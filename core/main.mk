...
ifdef FULL_BUILD
  ifneq (true,$(ALLOW_MISSING_DEPENDENCIES))
    ...
    ifeq (true,$(PRODUCT_ENFORCE_PACKAGES_EXIST))
      _allowlist := $(PRODUCT_ENFORCE_PACKAGES_EXIST_ALLOW_LIST)
      ...
      $(call maybe-print-list-and-error,$(filter-out $(_allowlist),$(_nonexistent_modules)),\
        $(INTERNAL_PRODUCT) includes non-existent modules in PRODUCT_PACKAGES)
      $(call maybe-print-list-and-error,$(filter-out $(_nonexistent_modules),$(_allowlist)),\
...
$(call dist-for-goals,droidcore,$(CERTIFICATE_VIOLATION_MODULES_FILENAME))
  ...
  $(foreach makefile,$(ARTIFACT_PATH_REQUIREMENT_PRODUCTS),\
    ...
    $(eval allowed := $(PRODUCT_ARTIFACT_PATH_REQUIREMENT_WHITELIST)) \
    $(eval allowed_patterns := $(call resolve-product-relative-paths,$(allowed))) \
