...
ADDITIONAL_PRODUCT_PROPERTIES += ro.product.ab_ota_partitions=$(subst $(space),$(comma),$(trim $(AB_OTA_PARTITIONS)))
endif
...
# TODO(asmundak):
# `product-installed-files` and `host-installed-files` macros below call
