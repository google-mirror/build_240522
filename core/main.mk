...
# Device board config can override this value to /product, to use
# /product/etc/fstab.postinstall to mount system_other partition.
# Otherwise, it uses the default value /system/etc/fstab.postinstall.
