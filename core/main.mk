...
$(eval $(call combine-notice-files, html, \
  ...
  ifeq ($(EMMA_INSTRUMENT),true)
    ...
    api_xmls := $(addprefix $(TARGET_OUT_COVERAGE)/,api.xml system-api.xml test-api.xml)
    $(api_xmls): $(TARGET_OUT_COVERAGE)/%api.xml : frameworks/base/api/%current.txt $(APICHECK)
