...
$(call dist-for-goals,droidcore,$(CERTIFICATE_VIOLATION_MODULES_FILENAME))
  ...
  $(foreach makefile,$(ARTIFACT_PATH_REQUIREMENT_PRODUCTS),\
    ...
    $(eval allow_multiple := $(PRODUCTS.$(makefile).ALLOW_MULTIPLE_ARTIFACT_PATH_REQUIREMENTS)) \
    $(if $(allow_multiple),, \
      $(eval ### If ALLOW_MULTIPLE_ARTIFACT_PATH_REQUIREMENTS isn't set, it checks every makefile.) \
  ...
  # Error handling logic for paths of which ALLOW_MULTIPLE_ARTIFACT_PATH_REQUIREMENTS is set.
