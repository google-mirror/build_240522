...
_partitions := SYSTEM VENDOR ODM PRODUCT
$(foreach p, $(_partitions),\
  $(if $(ADDITIONAL_$(p)_PROPERTIES),\
    $(error ADDITIONAL_$(p)_PROPERTIES must not set before here. $(ADDITIONAL_$(p)_PROPERTIES))\
  ,)\
  $(eval ADDITIONAL_$(p)_PROPERTIES :=)\
)
_partitions :=
