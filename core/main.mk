...
offending_artifacts_file := $(PRODUCT_OUT)/offending_artifacts.txt
$(shell rm -f $(offending_artifacts_file))
$(foreach makefile,$(ARTIFACT_PATH_REQUIREMENT_PRODUCTS),\
  ...
  $(file >>$(offending_artifacts_file),$(subst $(space),$(newline),$(sort $(strip $(files_in_requirement))))) \
