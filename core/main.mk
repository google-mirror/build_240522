...
ifeq ($(HOST_OS),darwin)
  ...
  $(call dist-for-goals,apps_only, $(PROGUARD_DICT_ZIP):$(call add_file_name_tag_suffix $(PROGUARD_DICT_ZIP)) $(PROGUARD_DICT_MAPPING):$(call add_file_name_tag_suffix $(PROGUARD_DICT_MAPPING)))
  ...
  $(call dist-for-goals,apps_only, $(PROGUARD_USAGE_ZIP):$(call add_file_name_tag_suffix $(PROGUARD_USAGE_ZIP)))
  $(call declare-container-license-deps,$(PROGUARD_USAGE_ZIP),$(apps_only_installed_files),$(PRODUCT_OUT)/:/)

  $(SYMBOLS_ZIP) : $(apps_only_installed_files)
  $(call dist-for-goals,apps_only, $(SYMBOLS_ZIP):$(call add_file_name_tag_suffix $(SYMBOLS_ZIP)) $(SYMBOLS_MAPPING):$(call add_file_name_tag_suffix $(SYMBOLS_MAPPING)))
...
$(call declare-0p-target,$(target_notice_html_or_xml))
  ...
  $(call dist-for-goals, droidcore-unbundled, \
    $(INTERNAL_UPDATE_PACKAGE_TARGET):$(call add_file_name_tag_suffix $(INTERNAL_OTA_PACKAGE_TARGET)) \
    $(INTERNAL_OTA_PACKAGE_TARGET):$(call add_file_name_tag_suffix $(INTERNAL_OTA_PACKAGE_TARGET)) \
    $(INTERNAL_OTA_METADATA) \
    $(INTERNAL_OTA_PARTIAL_PACKAGE_TARGET):$(call add_file_name_tag_suffix $(INTERNAL_OTA_PACKAGE_TARGET)) \
    $(INTERNAL_OTA_RETROFIT_DYNAMIC_PARTITIONS_PACKAGE_TARGET):$(call add_file_name_tag_suffix $(INTERNAL_OTA_PACKAGE_TARGET)) \
    $(SYMBOLS_ZIP):$(call add_file_name_tag_suffix $(SYMBOLS_ZIP)) \
    $(SYMBOLS_MAPPING):$(call add_file_name_tag_suffix $(SYMBOLS_MAPPING)) \
    $(PROGUARD_DICT_ZIP):$(call add_file_name_tag_suffix $(PROGUARD_DICT_ZIP)) \
    $(PROGUARD_DICT_MAPPING):$(call add_file_name_tag_suffix $(PROGUARD_DICT_MAPPING)) \
    $(PROGUARD_USAGE_ZIP):$(call add_file_name_tag_suffix $(PROGUARD_USAGE_ZIP)) \
    $(COVERAGE_ZIP) \
    $(INSTALLED_FILES_FILE) \
    $(INSTALLED_FILES_JSON) \
    $(INSTALLED_FILES_FILE_VENDOR) \
    ...
    $(BUILT_TARGET_FILES_PACKAGE):$(call add_file_name_tag_suffix $(INTERNAL_OTA_PACKAGE_TARGET)) \
    $(INSTALLED_ANDROID_INFO_TXT_TARGET) \
  ...
  ifneq ($(ANDROID_BUILD_EMBEDDED),true)
    $(call dist-for-goals, droidcore, \
      $(APPS_ZIP):$(call add_file_name_tag_suffix $(APPS_ZIP)) \
      $(INTERNAL_EMULATOR_PACKAGE_TARGET):$(call add_file_name_tag_suffix $(INTERNAL_EMULATOR_PACKAGE_TARGET)) \
    )
  endif
...
$(call dist-for-goals,sdk, \
    $(ALL_SDK_TARGETS):$(call add_file_name_tag_suffix $(ALL_SDK_TARGETS)) \
