...
$(call declare-0p-target,$(target_notice_html_or_xml))
  ...
  ifeq ($(BUILD_FROM_TEXT_STUB),true)
    $(TARGET_OUT_COMMON_INTERMEDIATES)/api.xml: $(call java-lib-files,android_from_text_stubs_current) $(APICHECK)
    $(TARGET_OUT_COMMON_INTERMEDIATES)/system-api.xml: $(call java-lib-files,android_from_text_system_stubs_current) $(APICHECK)
    $(TARGET_OUT_COMMON_INTERMEDIATES)/module-lib-api.xml: $(call java-lib-files,android_from_text_module_lib_stubs_current) $(APICHECK)
    $(TARGET_OUT_COMMON_INTERMEDIATES)/system-server-api.xml: $(call java-lib-files,android_from_text_system_server_stubs_current) $(APICHECK)
    $(TARGET_OUT_COMMON_INTERMEDIATES)/test-api.xml: $(call java-lib-files,android_from_text_test_stubs_current) $(APICHECK)
  else
