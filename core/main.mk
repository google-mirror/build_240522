...
$(PRODUCT_OUT)/sbom-metadata.csv: $(installed_files)
	...
	$(foreach l,$(sort $(_all_static_libs)), \
	  ...
	  @echo $(_lib_stem).a$(comma)$(_module_path)$(comma)$(_soong_module_type)$(comma)$(comma)$(comma)$(comma)$(comma)$(_built_file)$(comma)$(_static_libs)$(comma)$(_whole_static_libs)$(comma)$(_is_static_lib) >> $@ $(newline) \
	)
