...
findlsdumps: lsdump_paths
findlsdumps: $(foreach p,$(LSDUMP_PATHS),$(call word-colon,2,$(p)))

.PHONY: lsdump_paths
lsdump_paths:
	@echo "Generate $(LSDUMP_PATHS_FILE)"
	@rm -rf "$(LSDUMP_PATHS_FILE)"
	@echo -e "$(subst :,:$(space),$(subst $(space),\n,$(LSDUMP_PATHS)))" > "$(LSDUMP_PATHS_FILE)"
