...
# Instead of reading the build number and the hostname,
# it uses the file which Soong creates to avoid necessary rebuilding
# when only the build number or the hostname are changed.
# And the build number and hostname cannot be directly accessed in make because it is a file.
