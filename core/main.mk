...
my_static_link_type_deps_addprefix := $(addprefix --static_deps ,$(foreach l,$($(1).STATIC_DEPS),$(call link-type-file,$(l))))
my_link_type_file := $(call link-type-file,$(1))
$($(1).BUILT): | $$(my_link_type_file)
$$(my_link_type_file): PRIVATE_DEPS := $$(my_link_type_deps)
$$(my_link_type_file): PRIVATE_STATIC_DEPS := $$(my_static_link_type_deps_addprefix)
ifeq ($($(1).MISSING),true)
