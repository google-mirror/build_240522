...
ADDITIONAL_PRODUCT_PROPERTIES += ro.charger.draw_split_screen=$(TARGET_HEALTHD_DRAW_SPLIT_SCREEN)
endif
ifdef TARGET_HEALTHD_DRAW_SPLIT_OFFSET
ADDITIONAL_PRODUCT_PROPERTIES += ro.charger.draw_split_offset=$(TARGET_HEALTHD_DRAW_SPLIT_OFFSET)
endif
ifdef BOARD_CHARGER_DISABLE_INIT_BLANK
ADDITIONAL_PRODUCT_PROPERTIES += ro.charger.disable_init_blank=$(BOARD_CHARGER_DISABLE_INIT_BLANK)
endif
ifdef BOARD_CHARGER_ENABLE_SUSPEND
ADDITIONAL_PRODUCT_PROPERTIES += ro.charger.enable_suspend=$(BOARD_CHARGER_ENABLE_SUSPEND)
endif
ifdef BOARD_CHARGER_NO_UI
ADDITIONAL_PRODUCT_PROPERTIES += ro.charger.no_ui=$(BOARD_CHARGER_NO_UI)
endif
