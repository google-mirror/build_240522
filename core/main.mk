  ...
  $(if $(r), \
    ...
    $(eval r_r := \
      $(foreach r_i,$(r), \
        ...
        $(if $(r_m),,$(eval _nonexistent_required += $(1)$(_fs)$(m)$(_fs)$(1)$(_fs)$(r_i))) \
        $(r_m))) \
  ...
  $(if $(r), \
    $(eval r_r := \
      $(foreach r_i,$(r), \
        $(eval r_m := $(call resolve-bitness-for-modules,$(1),$(r_i))) \
        $(eval r_m := $(foreach r_j,$(r_m),$(if $(ALL_MODULES.$(r_j).PATH),$(r_j)))) \
        $(if $(r_m),,$(eval _nonexistent_required += $(2)$(_fs)$(m)$(_fs)$(1)$(_fs)$(r_i))) \
        $(r_m))) \
...
ifneq (,$(_nonexistent_required))
  ...
  $(foreach r_i,$(_nonexistent_required), \
    $(eval r := $(subst $(_fs),$(space),$(r_i))) \
    $(info $(word 1,$(r)) module $(word 2,$(r)) requires non-existent $(word 3,$(r)) module: $(word 4,$(r))) \
  )
  $(warning Set ALLOW_MISSING_DEPENDENCIES=true to bypass this check if this is intentional)
  $(error Build failed)
