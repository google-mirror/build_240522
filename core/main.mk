...
# Otherwise if the requirer module is native and the required module is shared
    ...
    $(eval r_m := \
      $(if $(filter %:32 %:64,$(r_i)), \
        ...
        $(eval required_is_shared_library_or_native_test := \
          $(filter SHARED_LIBRARIES NATIVE_TESTS,$(ALL_MODULES.$(r_i).CLASS) $(ALL_MODULES.$(r_i_2nd).CLASS))) \
