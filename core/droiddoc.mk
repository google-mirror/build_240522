...
# TODO(nanzhang): Remove it if this is used any more
$(full_target): PRIVATE_LOCAL_PATH := $(LOCAL_PATH)

ifeq ($(strip $(LOCAL_DROIDDOC_USE_METALAVA)),true)
ifneq (,$(filter --generate-documentation,$(LOCAL_DROIDDOC_OPTIONS)))

_pos_f = $(if $(findstring $1,$2),$(call _pos_f,$1,$(wordlist 2,$(words $2),$2),x $3),$3)
pos_f = $(words $(call _pos_f,$1,$2))
pos := $(call pos_f,--generate-documentation,$(LOCAL_DROIDDOC_OPTIONS))
metalava_args := $(wordlist 1, pos, $(LOCAL_DROIDDOC_OPTIONS))
remaining_args :=  $(wordlist pos, $(words $(LOCAL_DROIDDOC_OPTIONS)), $(LOCAL_DROIDDOC_OPTIONS))
...
$(full_target): \
	...
	$(hide) ( \
		$(JAVA) -jar $(HOST_OUT_JAVA_LIBRARIES)/metalava$(COMMON_JAVA_PACKAGE_SUFFIX) \
                ...
                --write-stubs-source-list $(intermediates.COMMON)/droiddoc-src-list \
                $(metalava_args) $(JAVADOC) -encoding UTF-8 -source 1.8 STUBS_SOURCE_LIST \
