...
# then drop PRIVATE_BOOTCLASSPATH and rename PRIVATE_BOOTCLASSPATH_ARG to
# PRIVATE_MODULE_ARG. For now, keep -bootclasspath here since it works
# in combination with -source 1.8.
$(full_target): \
        $(full_src_files) \
        $(droiddoc_templates) \
        $(droiddoc) \
...
# to work around the OpenJDK 9 module system. http://b/62039770
