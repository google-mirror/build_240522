...
ifneq ($(filter arm64,$(TARGET_$(LOCAL_2ND_ARCH_VAR_PREFIX)ARCH)),)
  my_sanitize := $(filter-out armv8_only_return_pac,$(my_sanitize))
  my_sanitize_diag := $(filter-out armv8_only_return_pac,$(my_sanitize_diag))
endif

# Disable armv8_only_bti sanitizer on architectures other than AArch64.
ifneq ($(filter arm64,$(TARGET_$(LOCAL_2ND_ARCH_VAR_PREFIX)ARCH)),)
  my_sanitize := $(filter-out armv8_only_bti,$(my_sanitize))
  my_sanitize_diag := $(filter-out armv8_only_bti,$(my_sanitize_diag))
endif
