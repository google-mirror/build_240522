...
ifeq ($(LOCAL_PROTOC_OPTIMIZE_TYPE),micro)
    ifneq ($(filter host-libprotobuf-java-2.3.0-micro,$(LOCAL_JAVA_LIBRARIES)),)
        ...
        my_static_libraries := $(filter-out host-libprotobuf-java-2.3.0-micro,$(my_static_libraries))
    endif
  ...
  ifeq ($(LOCAL_PROTOC_OPTIMIZE_TYPE),nano)
    ifneq ($(filter host-libprotobuf-java-2.3.0-nano,$(LOCAL_JAVA_LIBRARIES)),)
        ...
        my_static_libraries := $(filter-out host-libprotobuf-java-2.3.0-nano,$(my_static_libraries))
    endif
    ...
    ifneq ($(filter host-libprotobuf-java-2.3.0-lite,$(LOCAL_JAVA_LIBRARIES)),)
        ...
        my_static_libraries := $(filter-out host-libprotobuf-java-2.3.0-lite,$(my_static_libraries))
    endif
