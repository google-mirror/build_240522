...
ifndef PLATFORM_VERSION_CODENAME
  ...
  $(foreach version,$(ALL_VERSIONS),\
    $(if $(_all_codenames_done),,\
      $(eval _codename := $(PLATFORM_VERSION_CODENAME.$(version)))\
      $(if $(findstring $(_codename),$(PLATFORM_VERSION_ALL_CODENAMES)),,\
        $(eval PLATFORM_VERSION_ALL_CODENAMES += $(_codename)))\
      $(if $(findstring $(_codename),$(PLATFORM_VERSION_CODENAME)),\
        $(eval _all_codenames_done := true))))
