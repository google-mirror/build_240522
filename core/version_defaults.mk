...
# Returns all words in $1 after and including $2
define find_and_later
  $(strip $(if $(1),
    $(if $(filter $(firstword $(1)),$(2)),
      $(1),
      $(call find_and_later,$(wordlist 2,$(words $(1)),$(1)),$(2)))))
endef

#$(warning $(call find_and_later,A B C,A))
#$(warning $(call find_and_later,A B C,B))
#$(warning $(call find_and_later,A B C,C))
#$(warning $(call find_and_later,A B C,D))

define version-list
$(1)MR2 $(1)MR1 $(1)DR2 $(1)DR1 $(1)
endef
...
ENABLED_VERSIONS := $(call find_and_later,$(ALL_VERSIONS),$(TARGET_PLATFORM_VERSION))
