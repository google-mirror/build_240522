...
ifneq ($(LOCAL_SDK_VERSION),)
  ...
  LOCAL_JAVA_LIBRARIES := core-oj core-libart core-simple.impl ext framework $(LOCAL_JAVA_LIBRARIES)
  $(full_target): PRIVATE_BOOTCLASSPATH := $(call java-lib-files, core-oj):$(call java-lib-files, core-libart):$(call java-lib-files, core-simple.impl)
