...
ifneq ($(filter-out current system_current test_current core_current,$(LOCAL_SDK_VERSION))$(if $(filter true,$(TARGET_BUILD_USE_PREBUILT_SDKS)),$(filter current system_current test_current,$(LOCAL_SDK_VERSION))),)
...
ifneq (,$(filter true,$(TARGET_BUILD_USE_PREBUILT_SDKS))$(FORCE_BUILD_RS_COMPAT))
