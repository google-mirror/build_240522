...
ifneq ($(filter $(my_cxx_stl),libc++ libc++_static),)
    ...
    # Using an NDK STL. Handled in binary.mk, except for the unwinder. binary.mk
    # adds -ldl, which the unwinder needs for dl_iterate_phdr (or
    # dl_unwind_find_exidx on arm32).
