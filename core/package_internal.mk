...
$(LOCAL_BUILT_MODULE): $(private_key) $(certificate) $(SIGNAPK_JAR) $(APKSIGNER)
$(LOCAL_BUILT_MODULE): PRIVATE_PRIVATE_KEY := $(private_key)
$(LOCAL_BUILT_MODULE): PRIVATE_CERTIFICATE := $(certificate)
$(LOCAL_BUILT_MODULE): PRIVATE_LOCAL_CERTIFICATE := $(LOCAL_CERTIFICATE)
$(LOCAL_BUILT_MODULE): PRIVATE_PRODUCT_MODULE := $(LOCAL_PRODUCT_MODULE)

PACKAGES.$(LOCAL_PACKAGE_NAME).PRIVATE_KEY := $(private_key)
PACKAGES.$(LOCAL_PACKAGE_NAME).CERTIFICATE := $(certificate)
PACKAGES.$(LOCAL_PACKAGE_NAME).PRODUCT_MODULE := $(LOCAL_PRODUCT_MODULE)
