...
ifeq (true,$(LOCAL_VENDOR_MODULE))
  ...
  $(error $(LOCAL_MODULE_MAKEFILE): $(LOCAL_MODULE): runtime resource overlay package should not be installed in oem/overlay)
else ifeq (true,$(LOCAL_ODM_MODULE))
  $(error $(LOCAL_MODULE_MAKEFILE): $(LOCAL_MODULE): runtime resource overlay package should not be installed in odm/overlay)
