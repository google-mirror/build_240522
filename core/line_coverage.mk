...
# packs them into another zip file called `line_coverage_fuzz_targets.zip`.
#
...
$(line_coverage_profiles): $(SOONG_ZIP) $(PRODUCT_OUT)
...
$(line_coverage_fuzz_targets): $(SOONG_ZIP) $(PRODUCT_OUT)
	$(SOONG_ZIP) -o $@ -D $(PRODUCT_OUT)/obj/EXECUTABLES
