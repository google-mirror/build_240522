...
###########################################################
ifneq ($(filter $(LOCAL_MODULE),$(VNDK_LIBRARIES)),)
...
$(vndk_out_dump): $(linked_module) $(VNDK_DUMP_ABI) $(VT_DUMPER) $($(LOCAL_2ND_ARCH_VAR_PREFIX)TARGET_OBJDUMP) $($(LOCAL_2ND_ARCH_VAR_PREFIX)TARGET_READELF)
	$(call dump-vndk-abi, $@)
