...
# Don't use mini-debug-info on mips. objcopy checks that all SH_MIPS_DWARF sections
# having name prefix .debug_ or .zdebug_, so there seems no easy way using objcopy to
# remove all debug sections except .debug_frame on mips.
ifneq ($(filter mips,$($(my_prefix)$(LOCAL_2ND_ARCH_VAR_PREFIX)ARCH)),)
