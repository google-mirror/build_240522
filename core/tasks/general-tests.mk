...
$(general_tests_zip) : PRIVATE_HOST_SHARED_LIB_FILES := $(COMPATIBILITY.general-tests.HOST_SHARED_LIBRARY.FILES)
$(general_tests_zip) : $(COMPATIBILITY.general-tests.FILES) $(general_tests_tools) $(COMPATIBILITY.general-tests.HOST_SHARED_LIBRARY.DEPS) $(SOONG_ZIP)
	...
	$(hide) for shared_lib in $(PRIVATE_HOST_SHARED_LIB_FILES); do \
	  ...
	  cp -fp $$src $$dest; \
	  echo $$dest >> $(PRIVATE_INTERMEDIATES_DIR)/host.list; \
	done
