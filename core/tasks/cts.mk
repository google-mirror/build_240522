...
# ============================================================
.PHONY: cts-platform-version-check
...
cts-platform-version-check : $(cts_platform_version_path) build/core/version_defaults.mk
  ...
  $(shell echo $(cts_platform_version_string) > $(TARGET_OUT_ETC)/cts-platform-version-check)
