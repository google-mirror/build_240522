...
$(vndk_snapshot_zip): $(SOONG_VNDK_SNAPSHOT_ZIP)
	$(copy-file-to-target)
...
vendor_snapshot_zip := $(PRODUCT_OUT)/android-vendor-$(TARGET_PRODUCT).zip
$(vendor_snapshot_zip): $(SOONG_VENDOR_SNAPSHOT_ZIP)
	$(copy-file-to-target)

.PHONY: vendor-snapshot
vendor-snapshot: $(vendor_snapshot_zip)

$(call dist-for-goals, vendor-snapshot, $(vendor_snapshot_zip))
