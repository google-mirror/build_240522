...
# attempting to build this package will produce a build error.
#
...
$(my_package_zip) : $(my_built_modules)
    ...
    $(shell $(call echo-error,$(my_makefile),$(my_package_name): Unknown installed files: $(my_missing_files)))
    $(error done)
  else
    $(shell $(call echo-warning,$(my_makefile),$(my_package_name): Unknown installed files: $(my_missing_files)))
  endif
endif
