...
# Check build variables for chain configuration and set rollback index via
# footer args.
define custom-image-check-avb-chain-args
...
$(eval $(call custom-image-check-avb-chain-args))
endif
