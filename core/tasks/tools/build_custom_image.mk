...
$(my_built_custom_image): PRIVATE_MODULES := $(my_custom_image_modules)
$(my_built_custom_image): $(INTERNAL_USERIMAGES_DEPS) $(my_built_modules) $(my_image_copy_files) $(my_custom_image_modules_dep) \
  $(CUSTOM_IMAGE_DICT_FILE)
	...
	$(if $(PRIVATE_MODULES), \
		$(call build-image-kernel-modules,$(PRIVATE_MODULES),$(PRIVATE_STAGING_DIR),$(my_custom_image_name)/,$(call intermediates-dir-for,PACKAGING,depmod_$(my_custom_image_name))))
