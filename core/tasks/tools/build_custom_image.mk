...
PRIVATE_my_custom_image_modules_var:=BOARD_$(strip $(call to-upper,$(my_custom_image_name)))_KERNEL_MODULES
PRIVATE_my_custom_image_modules:=$($(PRIVATE_my_custom_image_modules_var))
PRIVATE_my_custom_image_modules_dep:=$(if $(PRIVATE_my_custom_image_modules),$(PRIVATE_my_custom_image_modules) $(DEPMOD),)
$(my_built_custom_image): $(INTERNAL_USERIMAGES_DEPS) $(my_built_modules) $(my_image_copy_files) $(PRIVATE_my_custom_image_modules_dep) \
  $(CUSTOM_IMAGE_DICT_FILE)
	...
	$(if $(PRIVATE_my_custom_image_modules), \
		$(call build-image-kernel-modules,$(PRIVATE_my_custom_image_modules),$(PRIVATE_STAGING_DIR),$(my_custom_image_name)/,$(call intermediates-dir-for,PACKAGING,depmod_$(my_custom_image_name))))
