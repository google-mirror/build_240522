...
$(device-tests-zip) : PRIVATE_SHARED_LIB_FILES := $(COMPATIBILITY.device-tests.shared_lib.FILES)
$(device-tests-zip) : $(COMPATIBILITY.device-tests.FILES) $(COMPATIBILITY.device-tests.shared_lib.DEPS) $(SOONG_ZIP)
