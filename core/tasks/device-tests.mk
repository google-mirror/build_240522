...
device-tests-configs-zip := $(PRODUCT_OUT)/device-tests-configs.zip
...
$(device-tests-zip) : .KATI_IMPLICIT_OUTPUTS := $(device-tests-list-zip) $(device-tests-configs-zip) $(device-tests-jars-zip)
...
$(call dist-for-goals, device-tests, $(device-tests-zip) $(device-tests-list-zip) $(device-tests-configs-zip) $(device-tests-jars-zip))
