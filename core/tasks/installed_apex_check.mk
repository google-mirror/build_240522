...
# Strip .flattened suffixes from the installed packages to compare with
# PRODUCT_INSTALL_APEXES. The `sort` call is mainly to remove duplicates.
_product_apexes := \
  $(sort \
    $(patsubst %.flattened,%,\
...
_product_apexes := $(filter-out com.android.vndk.%,$(_product_apexes))
