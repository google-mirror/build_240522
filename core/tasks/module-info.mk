...
# the m and atest commands. After timing this using $(shell date +"%s.%3N"),
# it only adds 0.01 seconds to the internal master build, and will only rerun on
# builds that rerun kati.
