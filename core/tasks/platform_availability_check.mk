...
$(info Following modules are requested to be installed but are not available for platform because \
they do not have "//apex_available:platform" or they depend on other modules that are not available \
for platform:)
$(foreach m,$(sort $(_modules_not_available_for_platform)),$(info $(m):$(word 1,$(ALL_MODULES.$(m).PATH))))
$(error Build failed)
endif
