...
my_dex_preopt_used_libraries := $(LOCAL_USED_LIBRARIES)
ifeq (,$(my_dex_preopt_used_libraries))
...
my_lib_names := $(basename $(notdir $(my_dex_preopt_used_libraries)))
...
my_stored_preopt_class_loader_context_arg := --stored-class-loader-context=PCL[$(call normalize-path-list,$(my_dex_preopt_used_libraries))]
endif
