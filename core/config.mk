...
# This Soong config variable is initialized here rather than in
# android_soong_config_vars.mk, because it is needed when parsing Android.mk
# files in ART sources, as long as they still may be present even though the
# prebuilts are used.
