...
# PLATFORM_SEPOLICY_VERSION is a number of the form "NN.0" with "NN" mapping to
# vFRC version.  This value will be set to 999999.0 to represent tip-of-tree
# development that is inherently unstable and thus designed not to work with any
# shipping vendor policy.  This is similar in spirit to how
# DEFAULT_APP_TARGET_SDK is set.
sepolicy_vers := 202404.0

TOT_SEPOLICY_VERSION := 999999.0
