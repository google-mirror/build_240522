...
INTERNAL_PLATFORM_DELETED_API_FILE := $(TARGET_OUT_COMMON_INTERMEDIATES)/PACKAGING/deleted.txt
...
INTERNAL_PLATFORM_SYSTEM_DELETED_API_FILE := $(TARGET_OUT_COMMON_INTERMEDIATES)/PACKAGING/system-deleted.txt
