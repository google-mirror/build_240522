...
RS_PREBUILT_LIBPATH := -L $(SOONG_OUT_DIR)/ndk/platforms/android-21/arch-$(TARGET_ARCH)/usr/lib
else
RS_PREBUILT_LIBPATH := -L $(SOONG_OUT_DIR)/ndk/platforms/android-9/arch-$(TARGET_ARCH)/usr/lib
endif
