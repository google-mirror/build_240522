...
# most rules into the local pool.  Explicity set the pool to "none" for rules that
...
$(warning USE_GOMA=$(USE_GOMA) RBE_POOL=$(RBE_POOL) GOMA_OR_RBE_POOL=$(GOMA_OR_RBE_POOL))
