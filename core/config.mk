...
ifdef DEVICE_FRAMEWORK_MANIFEST_INPUT_FILES
  FRAMEWORK_MANIFEST_INPUT_FILES += $(DEVICE_FRAMEWORK_MANIFEST_INPUT_FILES)
endif
$(.KATI_obsolete_var DEVICE_FRAMEWORK_MANIFEST_INPUT_FILES,No one should ever need to use this.)
