...
INTERNAL_PLATFORM_HIDDENAPI_DARK_GREYLIST_SOURCE := frameworks/base/config/hiddenapi-dark-greylist.txt
INTERNAL_PLATFORM_HIDDENAPI_BLACKLIST_SOURCE := frameworks/base/config/hiddenapi-blacklist.txt
