...
ifndef BOARD_AVB_VERSION
# `$(AVBTOOL) version` outputs "avbtool VERSION_MAJOR.VERSION_MINOR.VERSION_SUB"
BOARD_AVB_VERSION := $(shell $(AVBTOOL) version | cut -d" " -f2)
endif
# We only care about MAJOR and MINOR version.
BOARD_AVB_VERSION_MAJOR := $(shell echo $(BOARD_AVB_VERSION) | cut -d"." -f1)
BOARD_AVB_VERSION_MINOR := $(shell echo $(BOARD_AVB_VERSION) | cut -d"." -f2)
BOARD_AVB_VERSION := $(shell echo $(BOARD_AVB_VERSION_MAJOR).$(BOARD_AVB_VERSION_MINOR))
endif
