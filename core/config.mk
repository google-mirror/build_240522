...
# If vendor is listed in BOARD_SUPER_PARTITION_BLOCK_DEVICES, build retrofit full OTA package only
# if its image is actually available.
BOARD_BUILD_RETROFIT_DYNAMIC_PARTITIONS_OTA_PACKAGE :=

ifeq (,$(filter vendor,$(BOARD_SUPER_PARTITION_BLOCK_DEVICES)))
