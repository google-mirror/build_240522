...
TARGET_BUILD_USE_PREBUILT_SDK :=
ifdef TARGET_BUILD_UNBUNDLED # equivalent to UnbundledBuild()
  ifndef UNBUNDLED_BUILD_SDKS_FROM_SOURCE
    TARGET_BUILD_USE_PREBUILT_SDK := true # equivalent to UnbundledBuildUsePrebuiltSdks()
  endif
endif
