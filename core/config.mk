...
# If vendor is listed in BOARD_SUPER_PARTITION_BLOCK_DEVICES but without its image available (e.g.
# building an AOSP target without vendor image), don't build the retrofit full OTA package.
ifneq (,$(filter vendor,$(BOARD_SUPER_PARTITION_BLOCK_DEVICES)))
...
endif # BOARD_SUPER_PARTITION_BLOCK_DEVICES
