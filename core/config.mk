...
# If BOARD_SUPER_PARTITION_BLOCK_DEVICES is defined, this is a retrofit device.
ifdef BOARD_SUPER_PARTITION_SIZE
ifdef BOARD_SUPER_PARTITION_BLOCK_DEVICES

# The metadata device must be on the kernel command-line for retrofit devices.
ifeq ($(PRODUCT_USE_LOGICAL_PARTITIONS),true)
...
BOARD_KERNEL_CMDLINE += androidboot.super_partition_name=$(BOARD_SUPER_PARTITION_METADATA_DEVICE)
endif
