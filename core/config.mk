...
get-sdk-dir = $(HISTORICAL_SDK_VERSIONS_ROOT)/$(call get-sdk-version,$(1))/$(call get-sdk-api,$(1))
...
# $(1): LOCAL_SDK_VERSION
resolve-prebuilt-android-path = $(call get-sdk-dir,$(1))/android.jar

# Resolve LOCAL_SDK_VERSION to prebuilt framework.aidl
# $(1): An sdk version (LOCAL_SDK_VERSION)
resolve-prebuilt-aidl-path = $(call get-sdk-dir,$(call get-sdk-version,$(1)))/framework.aidl
