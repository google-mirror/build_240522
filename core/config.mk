...
# Check that TARGET_MAX_PAGE_SIZE_SUPPORTED is greater than 4096 only for ARM
# architectures.
ifneq ($(TARGET_MAX_PAGE_SIZE_SUPPORTED),4096)
  ifneq ($(TARGET_ARCH),arm64)
    ifneq ($(TARGET_ARCH),arm)
      $(error TARGET_MAX_PAGE_SIZE_SUPPORTED greater than 4096 is only supported in ARM architecture)
    endif
  endif
endif
