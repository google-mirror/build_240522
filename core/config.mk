...
# shell scripts; no .exe necessary.
...
ACP := $(prebuilt_sdk_tools_bin)/acp$(HOST_EXECUTABLE_SUFFIX)
AIDL := $(prebuilt_sdk_tools_bin)/aidl$(HOST_EXECUTABLE_SUFFIX)
AAPT := $(prebuilt_sdk_tools_bin)/aapt$(HOST_EXECUTABLE_SUFFIX)
ZIPALIGN := $(prebuilt_sdk_tools_bin)/zipalign$(HOST_EXECUTABLE_SUFFIX)
SIGNAPK_JAR := $(prebuilt_sdk_tools)/lib/signapk$(COMMON_JAVA_PACKAGE_SUFFIX)
LLVM_RS_CC := $(prebuilt_sdk_tools_bin)/llvm-rs-cc$(HOST_EXECUTABLE_SUFFIX)
BCC_COMPAT := $(prebuilt_sdk_tools_bin)/bcc_compat$(HOST_EXECUTABLE_SUFFIX)
