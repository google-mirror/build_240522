...
SIGNAPK_SHARED_LIBRARIES := $(HOST_OUT_SHARED_LIBRARIES)
...
SIGNAPK_SHARED_LIBRARIES := $(prebuilt_sdk_tools)/$(HOST_OS)/lib64
else
SIGNAPK_SHARED_LIBRARIES := $(prebuilt_sdk_tools)/$(HOST_OS)/lib
endif
