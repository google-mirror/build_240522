...
ifeq ($(PRODUCT_USE_PRODUCT_COMPATIBILITY_MATRIX),)
  ifdef PRODUCT_SHIPPING_API_LEVEL
    ifeq (true,$(call math_gt_or_eq,$(PRODUCT_SHIPPING_API_LEVEL),29))
      PRODUCT_USE_PRODUCT_COMPATIBILITY_MATRIX := true
    endif
  endif
endif
.KATI_READONLY := PRODUCT_USE_PRODUCT_COMPATIBILITY_MATRIX

#-- end VINTF related flags
