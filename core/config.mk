...
# Configure legacy hidl list libs
ifneq ($(PRODUCT_ALL_HIDL_LEGACY_APPS),)
  $(error Cannot specify PRODUCT_ALL_HIDL_LEGACY_APPS. Must specify \
        PRODUCT_PRODUCT_LEGACY_HIDL_APPS,PRODUCT_SYSTEM_LEGACY_HIDL_APPS,\
        PRODUCT_VENDOR_LEGACY_HIDL_APPS,PRODUCT_ODM_LEGACY_HIDL_APPS)
endif

PRODUCT_PRODUCT_LEGACY_HIDL_APPS ?=
PRODUCT_SYSTEM_LEGACY_HIDL_APPS ?=
PRODUCT_VENDOR_LEGACY_HIDL_APPS ?=
PRODUCT_ODM_LEGACY_HIDL_APPS ?=

PRODUCT_ALL_HIDL_LEGACY_APPS := \
    $(PRODUCT_PRODUCT_LEGACY_HIDL_APPS) \
    $(PRODUCT_SYSTEM_LEGACY_HIDL_APPS) \
    $(PRODUCT_VENDOR_LEGACY_HIDL_APPS) \
    $(PRODUCT_ODM_LEGACY_HIDL_APPS)
