...
DEX_SIGNATURES := build/make/tools/dex_signatures.sh
...
INTERNAL_PLATFORM_HIDDENAPI_TIMESTAMP := $(TARGET_OUT_COMMON_INTERMEDIATES)/PACKAGING/hiddenapi-boot-dex.timestamp
