...
ifeq (,$(strip $(BOARD_CUSTOM_MAKE_EFI_IMAGE)))
MAKE_EFI_IMAGE := $(HOST_OUT_EXECUTABLES)/make_efi_image$(HOST_EXECUTABLE_SUFFIX)
else
MAKE_EFI_IMAGE := $(BOARD_CUSTOM_MAKE_EFI_IMAGE)
endif
