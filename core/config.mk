...
ifndef BOARD_CURRENT_SDK_VERSION
  BOARD_CURRENT_SDK_VERSION := current
else
  ifdef PRODUCT_SHIPPING_API_LEVEL
    ifneq ($(call math_lt,$(BOARD_CURRENT_SDK_VERSION),$(PRODUCT_SHIPPING_API_LEVEL)),)
      $(error BOARD_CURRENT_SDK_VERSION ($(BOARD_CURRENT_SDK_VERSION)) must be greater than or equal to PRODUCT_SHIPPING_API_LEVEL ($(PRODUCT_SHIPPING_API_LEVEL)))
    endif
  endif
endif
.KATI_READONLY := BOARD_CURRENT_SDK_VERSION
