...
_INT_MAX_WORDS := x $(_INT_LIMIT_WORDS)

define int_check_valid
$(if $(call _int_greater-or-equal,$(_INT_LIMIT_WORDS),$(call _int_encode,$(1))),\
  $(if $(call _int_greater-or-equal,$(call _int_encode,$(1)),$(call _int_encode,0)),,\
    $(call pretty-error,nor-positive integer is not supported!)),\
      $(call pretty-error,integer greater than $(words $(_INT_LIMIT_WORDS)) is not supported!))
endef

# int_check_valid has to be invoked before calling _int_encode
define _int_encode
...
define int_plus
$(strip \
    $(call int_check_valid,$(1)) \
    $(call int_check_valid,$(2)) \
