...
$(check_elf_files_stamp): PRIVATE_SONAME := $(if $(prebuilt_module_is_a_library),$(my_installed_module_stem))
...
$(check_elf_files_stamp): $(my_prebuilt_src_file) $(CHECK_ELF_FILE)
...
ifneq ($(LOCAL_CHECK_ELF_FILES),disabled)
