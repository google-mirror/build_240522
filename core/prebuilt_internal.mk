...
ifeq ($(LOCAL_MODULE_MAKEFILE),$(SOONG_ANDROID_MK))
  ...
  ifdef LOCAL_USE_VNDK
    SPLIT_VENDOR.$(LOCAL_MODULE_CLASS).$(patsubst %.vendor,%,$(LOCAL_MODULE)) := $(LOCAL_MODULE).vendor
  endif
endif
...
# TODO: we should verify what this is linking against
$(my_link_type):
...
# TODO: remove? or move separately for vendor?
