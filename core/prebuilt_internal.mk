...
# TODO(jungjw): See if we can replace SCRIPT with ETC.
...
else ifneq (,$(filter ETC EXECUTABLES NATIVE_TESTS SCRIPT SHARED_LIBRARIES STATIC_LIBRARIES,$(LOCAL_MODULE_CLASS)))
  include $(BUILD_SYSTEM)/cc_prebuilt_internal.mk
else
  $(call pretty-error,Unexpected LOCAL_MODULE_CLASS: $(LOCAL_MODULE_CLASS))
endif
