...
$(gen_from_buildinfo_sh): $(INTERNAL_BUILD_ID_MAKEFILE) $(API_FINGERPRINT) | $(BUILD_DATETIME_FILE) $(BUILD_NUMBER_FILE) $(BUILDINFO_SH)
...
.PHONY: system-build-prop
system-build-prop: $(INSTALLED_BUILD_PROP_TARGET)
