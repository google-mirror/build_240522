...
$(eval $(call build-properties,vendor,$(INSTALLED_VENDOR_BUILD_PROP_TARGET),\
$(_prop_files_),$(_prop_vars_),\
...
$(eval $(call build-properties,product,$(INSTALLED_PRODUCT_BUILD_PROP_TARGET),\
$(_prop_files_),$(_prop_vars_),\
$(empty)))
...
$(eval $(call build-properties,odm,$(INSTALLED_ODM_BUILD_PROP_TARGET),\
...
$(eval $(call build-properties,system_ext,$(INSTALLED_SYSTEM_EXT_BUILD_PROP_TARGET),\
$(_prop_files_),$(_prop_vars_),\
$(empty)))
