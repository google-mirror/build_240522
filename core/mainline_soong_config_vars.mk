...
ifdef SOONG_CONFIG_mainline
$(error The Soong config namespace mainline is reserved.)
endif

$(call add_soong_config_namespace,mainline)

# Add variables to the namespace below:

ifdef MAINLINE_DOGFOOD
$(call add_soong_config_var_value,mainline,dev)
else
$(call add_soong_config_var_value,mainline,release)
endif
