...
$(KATI_obsolete_var TARGET_OUT_VENDOR_DLKM_EXECUTABLES, vendor_dlkm should not contain any executables, libraries, or apps)
TARGET_OUT_VENDOR_DLKM_OPTIONAL_EXECUTABLES :=
$(KATI_obsolete_var TARGET_OUT_VENDOR_DLKM_OPTIONAL_EXECUTABLES, vendor_dlkm should not contain any executables, libraries, or apps)
TARGET_OUT_VENDOR_DLKM_SHARED_LIBRARIES :=
$(KATI_obsolete_var TARGET_OUT_VENDOR_DLKM_SHARED_LIBRARIES, vendor_dlkm should not contain any executables, libraries, or apps)
TARGET_OUT_VENDOR_DLKM_RENDERSCRIPT_BITCODE :=
$(KATI_obsolete_var TARGET_OUT_VENDOR_DLKM_RENDERSCRIPT_BITCODE, vendor_dlkm should not contain any executables, libraries, or apps)
TARGET_OUT_VENDOR_DLKM_JAVA_LIBRARIES :=
$(KATI_obsolete_var TARGET_OUT_VENDOR_DLKM_JAVA_LIBRARIES, vendor_dlkm should not contain any executables, libraries, or apps)
TARGET_OUT_VENDOR_DLKM_APPS :=
$(KATI_obsolete_var TARGET_OUT_VENDOR_DLKM_APPS, vendor_dlkm should not contain any executables, libraries, or apps)
TARGET_OUT_VENDOR_DLKM_APPS_PRIVILEGED :=
$(KATI_obsolete_var TARGET_OUT_VENDOR_DLKM_APPS_PRIVILEGED, vendor_dlkm should not contain any executables, libraries, or apps)

$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_EXECUTABLES :=
$(KATI_obsolete_var $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_EXECUTABLES, vendor_dlkm should not contain any executables, libraries, or apps)
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_SHARED_LIBRARIES :=
$(KATI_obsolete_var $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_SHARED_LIBRARIES, vendor_dlkm should not contain any executables, libraries, or apps)
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_RENDERSCRIPT_BITCODE :=
$(KATI_obsolete_var $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_RENDERSCRIPT_BITCODE, vendor_dlkm should not contain any executables, libraries, or apps)
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_APPS :=
$(KATI_obsolete_var $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_APPS, vendor_dlkm should not contain any executables, libraries, or apps)
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_APPS_PRIVILEGED :=
$(KATI_obsolete_var $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_DLKM_APPS_PRIVILEGED, vendor_dlkm should not contain any executables, libraries, or apps)
