...
# This function is also in definitions.mk at the time of writing, but we don't import definitions in
# this file.
...
# For the TARGETS_WITH_OPTIONAL_PARTITION, we now check whether the TARGET_COPY_OUT_* variables have
# been defined in the product configuration. If they haven't, we set them to a default destination
# inside the system partition, e.g. VENDOR -> /system/vendor
...
# This additional check makes sure the TARGETS_WITH_OPTIONAL_PARTITION are either placed in their
# own partition or under /system.
