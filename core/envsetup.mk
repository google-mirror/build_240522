...
TARGET_COPY_OUT_MAINLINE := mainline
...
# Unlike other partitions, mainline partition should only contain APEXes.
TARGET_OUT_MAINLINE := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_MAINLINE)
.KATI_READONLY := TARGET_OUT_MAINLINE
ifneq ($(filter address,$(SANITIZE_TARGET)),)
ifeq ($(SANITIZE_LITE),true)
# When using SANITIZE_LITE, APKs must not be packaged with sanitized libraries, as they will not
# work with unsanitized app_process. For simplicity, generate APKs into /data/asan/.
target_out_mainline_app_base := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_ASAN)/$(TARGET_COPY_OUT_MAINLINE)
else
target_out_mainline_app_base := $(TARGET_OUT_MAINLINE)
endif
else
target_out_mainline_app_base := $(TARGET_OUT_MAINLINE)
endif

TARGET_OUT_MAINLINE_EXECUTABLES :=
TARGET_OUT_MAINLINE_OPTIONAL_EXECUTABLES :=
TARGET_OUT_MAINLINE_SHARED_LIBRARIES :=
TARGET_OUT_MAINLINE_RENDERSCRIPT_BITCODE :=
TARGET_OUT_MAINLINE_JAVA_LIBRARIES :=
TARGET_OUT_MAINLINE_APPS :=
TARGET_OUT_MAINLINE_APPS_PRIVILEGED :=
TARGET_OUT_MAINLINE_ETC :=
.KATI_READONLY := \
  TARGET_OUT_MAINLINE_EXECUTABLES \
  TARGET_OUT_MAINLINE_OPTIONAL_EXECUTABLES \
  TARGET_OUT_MAINLINE_SHARED_LIBRARIES \
...
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_EXECUTABLES :=
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_SHARED_LIBRARIES :=
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_RENDERSCRIPT_BITCODE :=
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_APPS :=
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_APPS_PRIVILEGED :=
.KATI_READONLY := \
  $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_EXECUTABLES \
  $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_SHARED_LIBRARIES \
  $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_RENDERSCRIPT_BITCODE \
...
$(KATI_obsolete_var \
    ...
    $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_APPS \
    $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_MAINLINE_APPS_PRIVILEGED \
    , mainline partition should not contain any executables, libraries, or apps. It should only contain APEXes)
