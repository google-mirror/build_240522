...
# If the windows sdk should be built, also include rules to
# cross-build windows binaries on linux.
HOST_CROSS_OS :=
ifeq ($(HOST_OS),linux)
ifneq ($(filter win_sdk winsdk-tools buildwindows,$(MAKECMDGOALS)),)
