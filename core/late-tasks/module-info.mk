...
define _MODULE_INFO_JSON
{
$(KATI_foreach_sep m,$(COMMA)$(_NEWLINE), $(sort $(ALL_MODULES)),\
	 "$(m)": { \
...
# Create the file within kati.  See b/281536278.
$(KATI_file_no_rerun >$(MODULE_INFO_JSON),$(_MODULE_INFO_JSON))
