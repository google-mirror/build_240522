...
public class OptionsTest {
    ...
    public void testErrorMissingLast() {
        ...
        Assert.assertNotEquals("", ErrorsAssert.getErrorMessages(errors));
        Assert.assertEquals(Options.Action.ERROR, options.getAction());
        ErrorsAssert.assertHasEntry(errors.ERROR_COMMAND_LINE, errors);
    }
    ...
    public void testErrorOne() {
        ...
        Assert.assertEquals("", ErrorsAssert.getErrorMessages(errors));
