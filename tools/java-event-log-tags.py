...
buf = StringIO()
buf.write("/* This file is auto-generated.  DO NOT MODIFY.\n"
             " * Source file: %s\n"
             " */\n\n" % (fn,))
...
buf.write("  private %s() { }  // don't instantiate\n" % (basename,))
...
for t in tagfile.tags:
  ...
  buf.write("  public static final int %s = %d;\n" %
...
for t in tagfile.tags:
  ...
  if t.description:
    ...
    args = []
  argTypesNames = ", ".join(
    [javaTypes[int(arg[1])] + " " + javaName(arg[0]) for arg in args])
  argNames = "".join([", " + javaName(arg[0]) for arg in args])
  buf.write("\n  public static void %s(%s) {" % (methodName, argTypesNames))
  buf.write("\n    android.util.EventLog.writeEvent(%s%s);" %
            (t.tagname.upper(), argNames))
  buf.write("\n  }\n")
...
event_log_tags.WriteOutput(output_file, buf)
