...
def tagfileToJavaFile(tagfile: event_log_tags.TagFile) -> str:
...
def main():
  ...
  parser.add_argument("-o", dest="output_file", help="The output file")
  ...
  java_file_contents = tagfileToJavaFile(tagfile)
