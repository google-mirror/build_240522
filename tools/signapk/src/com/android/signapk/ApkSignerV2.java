...
public abstract class ApkSignerV2 {
    ...
    public static final int SIGNATURE_RSAPSS_WITH_SHA256_AND_ZERO_LENGTH_SALT = 0x0103;
    public static final int SIGNATURE_RSAPSS_WITH_SHA512_AND_ZERO_LENGTH_SALT = 0x0104;
        ...
        try {
            contentDigests =
                    computeContentDigests(
                            ...
                            new ByteBuffer[] {beforeCentralDir, centralDir, endOfCentralDir});
    ...
    private static Pair<String, ? extends AlgorithmParameterSpec>
        ...
        switch (sigAlgorithm) {
            ...
            case SIGNATURE_RSAPSS_WITH_SHA256_AND_ZERO_LENGTH_SALT:
                return Pair.create(
                        "SHA256withRSA/PSS",
                        new PSSParameterSpec(
                                "SHA-256", "MGF1", MGF1ParameterSpec.SHA256, 0, 1));
            case SIGNATURE_RSAPSS_WITH_SHA512_AND_ZERO_LENGTH_SALT:
                return Pair.create(
                        "SHA512withRSA/PSS",
                        new PSSParameterSpec(
                                "SHA-512", "MGF1", MGF1ParameterSpec.SHA512, 0, 1));
