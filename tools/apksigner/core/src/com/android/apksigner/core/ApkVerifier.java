...
public class ApkVerifier {
    ...
    public Result verify(DataSource apk, int minSdkVersion) throws IOException, ZipFormatException {
        ...
        if (result.isVerifiedUsingV2Scheme()) {
            ...
            throw new RuntimeException(
                    "APK considered verified, but has not verified using v2 scheme");
        }
    ...
    public static enum Issue {
         ...
         *
         * <ul>
         * <li>Parameter 1: index (1-based) of the certificate in the signer's list of
         *     certificates ({@code Integer})</li>
         * <li>Parameter 2: error details ({@code Throwable})</li>
         * </ul>
         */
        V2_SIG_MALFORMED_CERTIFICATE("Malformed certificate #%1$d: %2$s"),
