...
public interface ApkSignerEngine {
     ...
     *         to inspect the entry's contents
     */
     ...
     *
     * @return {@code true} if this entry should also be removed from output
     */
     ...
     *         a v1 signature. The request will contain additional JAR entries to be output. After
     *         the request is fulfilled, this method needs to be invoked again.
     *
     * @throws InvalidKeyException if a signature could not be generated because a signing key is
     *         not suitable for generating the signature
     * @throws SignatureException if an error occurred while generating the signature
     */
    AddV1SignatureRequest outputJarEntries()
     ...
     * @throws SignatureException if an error occurred while generating the signature
     */
    AddV2SignatureRequest outputZipSections(
     ...
     */
    interface AddV1SignatureRequest {
     ...
     */
    interface AddV2SignatureRequest {
