...
//          try {
//              signedData = new CMSSignedData(sigBlockBytes);
//          } catch (CMSException e) {
//              signerInfo.errors.add("Malformed " + sigBlockFile.getName());
//              continue;
//          }
...
//              signerInfo.errors.add("No signers in " + sigBlockFile.getName());
//              continue;
//          } else if (signerInfos.size() > 1) {
//              signerInfo.errors.add("More than one signer in " + sigBlockFile.getName());
//              continue;
//          }
    //
...
//                  signedData.getCertificates().getMatches(signer.getSID());
//          SignerInformationVerifier signerVerifier =
//                  new SignerInformationVerifier(
//                          new DefaultCMSSignatureAlgorithmNameGenerator(),
//                          new DefaultSignatureAlgorithmIdentifierFinder(),
//                          (ContentVerifierProvider) null,
//                          (DigestCalculatorProvider) null);
