...
public class EocdRecord {
    ...
    public static ByteBuffer createWithModifiedCentralDirectoryInfo(
        ...
        ZipUtils.setUnsignedInt16(
                result, EocdRecord.CD_RECORD_COUNT_ON_DISK_OFFSET, centralDirectoryRecordCount);
        ZipUtils.setUnsignedInt16(
                result, EocdRecord.CD_RECORD_COUNT_TOTAL_OFFSET, centralDirectoryRecordCount);
        ZipUtils.setUnsignedInt32(
                result, EocdRecord.CD_SIZE_OFFSET, centralDirectorySizeBytes);
        ZipUtils.setUnsignedInt32(
                result, EocdRecord.CD_OFFSET_OFFSET, centralDirectoryOffset);
        return result;
    }
}
