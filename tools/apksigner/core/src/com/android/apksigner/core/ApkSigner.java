...
import com.android.apksigner.core.DefaultApkSignerEngine.Builder;
...
public class ApkSigner {
    ...
    private static long outputInputJarEntryLfhRecordPreservingDataAlignment(
        ...
        // This record's data needs to be re-aligned. This is achieved using the record's extra
        // field.
    ...
    public static class Builder {
         ...
         * {@code outputApkOut} sink be visible through the {@code outputApkIn} data source.
         *
