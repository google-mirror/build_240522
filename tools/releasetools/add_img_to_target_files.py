...
def CreateImage(input_dir, info_dict, what, output_file, block_list=None):
  ...
  avb_enable = (image_props.get("avb_hash_enable") == "true" or
                image_props.get("avb_hashtree_enable") == "true")
  if (is_verity_partition and verity_supported) or avb_enable:
  ...
  if os.path.exists(ab_partitions):
    ...
    for line in lines:
      if line.strip() == "system" and (
          ...
          OPTIONS.info_dict.get("system_avb_hash_enable") == "true" or
      ...
      if line.strip() == "vendor" and (
          ...
          OPTIONS.info_dict.get("vendor_avb_hash_enable") == "true" or
