...
# Partitions that should have their care_map added to META/care_map.proto
...
def AddCareMapForAbOta(output_zip, ab_partitions, image_paths):
  """Generates and adds care_map.proto for system and vendor partitions.

  Args:
    output_zip: The output zip file (needs to be already open), or None to
        write care_map.proto to OPTIONS.input_tmp/.
    ab_partitions: The list of A/B partitions.
  ...
  care_map_path = "META/care_map.proto"
...
def ReplaceUpdatedFiles(zip_filename, files_list):
  ...
  For now the list includes META/care_map.proto, and the related files under
...
def AddImagesToTargetFiles(filename):
  ...
  if os.path.exists(ab_partitions_txt):
    ...
    # Generate care_map.proto for system and vendor partitions (if present),
