...
def AddImagesToTargetFiles(filename):
  ...
  # {vendor,odm,product}.img is unlike system.img or system_other.img.
  # Because it could be built from source, or dropped into target_files.zip
  # as a prebuilt blob. We consider either of them as {vendor,odm,product}.img
