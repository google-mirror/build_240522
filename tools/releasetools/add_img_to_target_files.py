...
def AppendVBMetaArgsForPartition(cmd, partition, img_path, public_key_dir):
  ...
  key_path = OPTIONS.info_dict.get("avb_" + partition + "_key_path", None)
  if key_path is not None:
    ...
    algorithm = OPTIONS.info_dict.get("avb_" + partition + "_algorithm", None)
    rollback_index_location = OPTIONS.info_dict.get(
        "avb_" + partition + "_rollback_index_location", None)
