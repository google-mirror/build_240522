...
def GetCareMap(which, imgname):
  ...
  if image_blocks:
    assert image_blocks > 0, "blocks should be positive for " + which
...
def CreateImage(input_dir, info_dict, what, output_file, block_list=None):
  ...
  # Set the '_image_blocks' that excludes the verity blocks of the given image.
  # When AVB is enabled, this size is the max image size returned by the AVB
  # tool.
