...
def AddImagesToTargetFiles(filename):
  ...
  # We consider either of them as {vendor,product,system_ext}.img being available,
  # which could b used when generating vbmeta.img for AVB.
  ...
  has_modules = HasPartition("modules")
