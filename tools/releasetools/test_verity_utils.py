...
from verity_utils import (
    ...
    VerifiedBootVersion1HashtreeInfoGenerator, VerityImageBuilder,
...
class VerifiedBootVersion2VerityImageBuilderTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.builder = VerityImageBuilder.Create(prop_dict)
  ...
  def test_CalculateMinPartitionSize_SlowerGrowthFooterSize(self):
