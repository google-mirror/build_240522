...
def ImagePropFromGlobalDict(glob_dict, mount_point):
  ...
  if mount_point == "system":
    ...
    copy_prop("productservices_squashfs_compressor_opt", "squashfs_compressor_opt")
    copy_prop("productservices_squashfs_block_size", "squashfs_block_size")
    copy_prop("productservices_squashfs_disable_4k_align", "squashfs_disable_4k_align")
