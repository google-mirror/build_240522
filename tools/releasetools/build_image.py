...
def BuildImage(in_dir, prop_dict, out_file, target_out=None):
  """Builds an image to out_file from in_dir with property prop dict.
  ...
  run_e2fsck = (fs_type.startswith("ext") and
                "extfs_sparse_flag" in prop_dict and
                prop_dict.get("skip_fsck") != "true")
  if run_e2fsck:
