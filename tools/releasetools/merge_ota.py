...
def main(argv):
  ...
  parser.add_argument('--payload_signer_args', type=str,
  ...
  if args.payload_signer_args:
    common.OPTIONS.payload_signer_args = shlex.split(args.payload_signer_args)
  if args.payload_signer_maximum_signature_size:
    common.OPTIONS.payload_signer_maximum_signature_size = args.payload_signer_maximum_signature_size
