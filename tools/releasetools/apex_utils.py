...
class ApexApkSigner(object):
  ...
  def __init__(self, apex_path, key_passwords, codename_to_api_level_map, avbtool=None, sign_tool=None, fsverity_path=None):
    ...
    self.fsverity_path = fsverity_path

  def ProcessApexFile(self, apk_keys, payload_key, signing_args=None, sepolicy_key=None, sepolicy_cert=None):
  ...
  def SignSePolicy(self, payload_dir, sepolicy_zip, sepolicy_key, sepolicy_cert):
    ...
    fsverity_path = self.fsverity_path if self.fsverity_path else 'fsverity'
    fsverity_cmd = [fsverity_path, 'sign', policy_zip_path, fsv_sig_out_path,
...
def SignUncompressedApex(avbtool, apex_file, payload_key, container_key,
                         ...
                         sepolicy_key=None, sepolicy_cert=None, fsverity_path=None):
  ...
  Args:
    ...
    fsverity_path: fsverity path to sign sepolicy zip.
  ...
  apk_signer = ApexApkSigner(apex_file, container_pw,
                             ...
                             avbtool, sign_tool, fsverity_path)
  apex_file = apk_signer.ProcessApexFile(
      apk_keys, payload_key, signing_args, sepolicy_key, sepolicy_cert)
