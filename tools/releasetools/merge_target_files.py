...
def process_special_cases(temp_dir, framework_meta, vendor_meta,
  ...
  Args:
    temp_dir: Location where the output directory where the target files
      have been extracted, e.g. <temp_dir>/output/SYSTEM,
      <temp_dir>/output/IMAGES, etc.
...
def process_dexopt(temp_dir, framework_meta, vendor_meta,
  ...
  Args:
    temp_dir: Location where the output directory where the target files have been
      extracted, e.g. <temp_dir>/output/SYSTEM, <temp_dir>/output/IMAGES, etc.,
      and also a scratch directory that we use for temporary files.
    framework_meta: The name of a directory containing the special items
      extracted from the framework target files package.
  ...
  if not use_system_other_odex:
    ...
    #                    and S(vendor) may require logic silimiar to that in
