...
def process_special_cases(framework_target_files_temp_dir,
  ...
  common.ProcessDynamicPartitionsInfoTxt(
...
def merge_target_files(temp_dir, framework_target_files, framework_item_list,
  ...
  common.GenerateSuperEmpty(output_target_files_temp_dir, output_super_empty)
  ...
  if output_img:
    img_from_target_files.ImgFromTargetFiles([output_zip], output_img)
