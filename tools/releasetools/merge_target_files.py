...
Usage: merge_target_files.py [args]
  ...
  --other-item-list other-item-list-file
      The path to a newline-separated config file that replaces the contents
      of default_other_item_list if provided.
