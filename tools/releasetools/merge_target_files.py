...
def set_copied_image_size_props(misc_info, images_dir):
  ...
  for partition in common.PARTITIONS_WITH_CARE_MAP:
    ...
    if os.path.exists(image_path):
      image_props = build_image.ImagePropFromGlobalDict(misc_info, partition)
      ...
      misc_info[image_size_prop] = verity_image_builder.CalculateMaxImageSize(
          partition_size)
...
def merge_meta_files(temp_dir, merged_dir):
  ...
  if OPTIONS.merged_misc_info.get('ab_update') == 'true':
    set_copied_image_size_props(
        misc_info=OPTIONS.merged_misc_info,
