...
__doc__ = """This script merges two partial target files packages (one of which contains
...
def main():
  ...
  if len(args) != 0 or \
      OPTIONS.system_target_files == None or \
      OPTIONS.other_target_files == None or \
      OPTIONS.output_target_files == None:
