...
class AbOtaPackage(OtaPackage):
  ...
  def Generate(self, target_file, source_file=None):
    ...
    if OPTIONS.downgrade:
      ...
      max_timestamp = self.metadata["post-timestamp"]
    additional_args = ["--max_timestamp", max_timestamp]

    self.payload.Generate(target_file, source_file, additional_args)
    ...
    if self._include_secondary:
      ...
      self.secondary_payload.Generate(
          secondary_target_file, additional_args=additional_args)
