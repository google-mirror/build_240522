...
def WriteABOTAPackageWithBrilloScript(target_file, output_file,
  ...
  if (target_info.get("verity") == "true" or
    ...
    care_map_list = list(filter(lambda x: "META/" + x in target_zip.namelist(),
                                ["care_map.proto", "care_map.txt"]))
    ...
    if care_map_list:
      ...
      # In order to support streaming, care_map.proto needs to be packed as
      # ZIP_STORED.
