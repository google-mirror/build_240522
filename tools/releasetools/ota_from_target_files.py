...
def GenerateAbOtaPackage(target_file, output_file, source_file=None):
  ...
  if OPTIONS.downgrade:
    ...
    partition_timestamps_flags = GeneratePartitionTimestampFlags(metadata.postcondition.partition_state)

  additional_args += ["--max_timestamp", max_timestamp]

  payload.Generate(target_file, source_file, additional_args + partition_timestamps_flags)
  ...
  if OPTIONS.include_secondary:
    ...
    secondary_payload.Generate(secondary_target_file,
                               additional_args=additional_args+partition_timestamps_flags)
