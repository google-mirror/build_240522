...
def main(argv):
  ...
  # Load the target build info dict from the zip directly or the extracted
  # input directory to have a peek at the OTA type. For A/B OTAs, unzipping the
  # entire target-files zip is unnecessary.
