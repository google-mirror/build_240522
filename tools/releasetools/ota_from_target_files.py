...
def GenerateAbOtaPackage(target_file, output_file, source_file=None):
  ...
  if source_file is not None:
    ...
    if not source_info.vabc_cow_version or target_info.vabc_cow_version:
      OPTIONS.vabc_cow_version = 2
    elif source_info.vabc_cow_version != target_info.vabc_cow_version:
      logger.info("Source and Target have different cow versions specified, default to minimum version")
