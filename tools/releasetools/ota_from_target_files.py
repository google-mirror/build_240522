  ...
  def __init__(self, info_dict, oem_dicts):
    ...
    Arguments:
      ...
      oem_dicts: A list of OEM dicts (should be parsed from --oem_settings).
          Note that it uses the first dict to calculate fingerprint of device
          name. The rest would be used for asserting OEM properties only (e.g.
          one package can be installed on one of these devices).
    """
