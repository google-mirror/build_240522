...
def WriteBlockIncrementalOTAPackage(target_zip, source_zip, output_zip):
  ...
  # TODO: Currently it's handling differently from
  # WriteIncrementalOTAPackage(), where in this function it doesn't consider
  # thumbprints when writing metadata["pre/post-build"]. One possible reason
  # is that the current devices with thumbprints are all using file-based OTAs.
  # Long term we should factor out the common parts into a shared one to avoid
  # further divergence.
