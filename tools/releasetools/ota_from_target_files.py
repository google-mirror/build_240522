  ...
  if source_file is not None:
    ...
    if not OPTIONS.vabc_cow_version:
      if not source_info.vabc_cow_version or not target_info.vabc_cow_version:
        ...
        logger.info("Source and Target have different cow VABC_COW_VERSION specified, default to minimum version: " + min(source_info.vabc_cow_version, target_info.vabc_cow_version) )
