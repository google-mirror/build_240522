...
""" % bcb_dev)
  ...
  if HasVendorPartition(input_zip):
    ...
    if GetBuildProp("ro.treble.enabled", OPTIONS.info_dict) == "true":
...
def WriteBlockIncrementalOTAPackage(target_zip, source_zip, output_zip):
  ...
  # Include compatibility info if it's treble-enabled target.
  if (HasVendorPartition(target_zip) and
      GetBuildProp("ro.treble.enabled", OPTIONS.target_info_dict) == "true"):
...
def WriteABOTAPackageWithBrilloScript(target_file, output_file,
  ...
  if (HasVendorPartition(target_zip) and
      GetBuildProp("ro.treble.enabled", OPTIONS.info_dict) == "true"):
