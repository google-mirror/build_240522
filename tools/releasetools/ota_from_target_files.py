...
Usage:  ota_from_target_files [flags] input_target_files output_ota_package
  ...
  --include_secondary
      ...
      reboots the device into the newly updated slot. It then continues to
      install the secondary payload to the inactive slot, but without switching
      the active slot at the end (needs the matching support in update_engine,
      i.e. SWITCH_SLOT_ON_REBOOT flag).
