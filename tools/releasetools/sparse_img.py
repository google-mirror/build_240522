...
class SparseImage(Image):
  ...
  def __init__(self, simg_fn, file_map_fn=None, clobbered_blocks=None,
    ...
    if file_map_fn:
      self.file_map = self.BuildFileMap(file_map_fn, allow_shared_blocks)
    else:
  ...
  def BuildFileMap(self, file_map_fn, allow_shared_blocks):
    ...
    return Image.LoadFileBlockMap(self.care_map, file_map_fn, self.blocksize,
                                  self.clobbered_blocks, self.hashtree_info,
                                  SparseImageReader, allow_shared_blocks)
