...
class BlockImageDiff(object):
  ...
  def CanUseImgdiff(self, name, tgt_ranges, src_ranges, large_apk=False):
    ...
    if (self.tgt_ranges.extra.get('uses_shared_blocks') or
        self.src_ranges.extra.get('uses_shared_blocks')):
      imgdiff_stats.Log(self.tgt_name, ImgdiffStats.SKIPPED_SHARED_BLOCKS)
      return False
