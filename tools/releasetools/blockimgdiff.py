...
class BlockImageDiff(object):
  ...
  def WriteTransfers(self, prefix):
    ...
    if self.verity_tree_info:
      out.append("compute_hash_tree {} {} {} {} {}\n".format(
          self.verity_tree_info.verity_tree_range,
          self.verity_tree_info.file_system_range,
  ...
  def FindTransfers(self):
    ...
    if self.verity_tree_info:
      ...
      print("verity tree ranges {}".format(verity_tree_range.to_string()))

    for tgt_fn, tgt_ranges in sorted(self.tgt.file_map.items()):
      if tgt_ranges.overlaps(verity_tree_range):
        print(tgt_fn, tgt_ranges.to_string())
