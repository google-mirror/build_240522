...
class BlockImageDiff(object):
  ...
  def FindTransfers(self):
    ...
    def AddSplitTransfersWrapper(tgt_name, src_name, tgt_ranges, src_ranges,
                                 style, by_id):
      """Wrapper function for AddSplitTransfers(...)
      ...
      while True:
        ...
        if p.returncode != 0:
          print("Failed to create patch between {} and {},"
                " fall back to bsdiff".format(src_name, tgt_name))
          with transfer_lock:
            AddSplitTransfers(tgt_name, src_name, tgt_ranges, src_ranges,
                              "diff", self.transfers)
          return
