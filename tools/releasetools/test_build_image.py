...
class BuildImageTest(ReleaseToolsTestCase):
  ...
  def test_GetFilesystemCharacteristics(self):
    ...
    self.assertEqual('4096', fs_dict['Block size'])
    self.assertEqual('88', fs_dict['Free blocks'])
    self.assertEqual('64', fs_dict['Inode count'])
    self.assertEqual('53', fs_dict['Free inodes'])
