...
class BuildImageTest(unittest.TestCase):
  ...
  def setUp(self):
    # To test AVBCalcMinPartitionSize(), by using 1GB to 2GB image size.
    #   - 262144 = 1GB * 1024 * 1024 * 1024 / 4096
    #   - 524288 = 2GB * 1024 * 1024 * 1024 / 4096
    self._image_sizes = [BLOCK_SIZE * random.randint(262144, 524288) + offset
  ...
  def test_AVBCalcMinPartitionSize_SlowerGrowthFooterSize(self):
    ...
    def _SizeCalculator(partition_size):
      """Footer size the is square root of partition size."""
      # Minus footer size to return max image size.
      return partition_size - int(math.sqrt(partition_size))
