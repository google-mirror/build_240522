...
class OtaFromTargetFilesTest(test_utils.ReleaseToolsTestCase):
  target_system_build_prop = common.PartitionBuildProps('unknown', 'system')
  target_system_build_prop.build_props = {
  ...
  TEST_TARGET_INFO_DICT = {'build.prop': target_system_build_prop}

  source_system_build_prop = common.PartitionBuildProps('unknown', 'system')
  source_system_build_prop.build_props = {
      'ro.product.device': 'product-device',
  ...
  TEST_SOURCE_INFO_DICT = {'build.prop' : source_system_build_prop}

  build_prop_with_oem = common.PartitionBuildProps('unknown', 'system')
  build_prop_with_oem.build_props = {
      'ro.product.name': 'product-name',
      'ro.build.thumbprint': 'build-thumbprint',
      'ro.build.bar': 'build-bar',
  }
  vendor_build_prop_with_oem = common.PartitionBuildProps('unknown', 'vendor')
  vendor_build_prop_with_oem.build_props = {
      'ro.vendor.build.fingerprint': 'vendor-build-fingerprint',
  }
  TEST_INFO_DICT_USES_OEM_PROPS = {
      'build.prop': build_prop_with_oem,
      'vendor.build.prop': vendor_build_prop_with_oem,
      'property1': 'value1',
      'property2': 4096,
