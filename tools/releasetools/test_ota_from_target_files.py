...
class StreamingPropertyFilesTest(PropertyFilesTest):
  """Additional checks specialized for StreamingPropertyFiles."""
...
class AbOtaPropertyFilesTest(PropertyFilesTest):
  """Additional checks specialized for AbOtaPropertyFiles."""
...
class NonAbOtaPropertyFilesTest(PropertyFilesTest):
  """Additional checks specialized for NonAbOtaPropertyFiles."""
