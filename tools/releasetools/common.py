...
# TODO(zhangkelvin) Ugly. We do this to keep compatibility because
# some scripts will reference non-AB code by common.SomeFunc. Remove
# this once non-AB is deprecated.
from non_ab_ota import DeviceSpecificParams, BlockDifference, GetUserImage, DynamicPartitionsDifference
