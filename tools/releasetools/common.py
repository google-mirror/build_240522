...
def MergeInfoDicts(framework_dict,
                   vendor_dict,
                   framework_keys):
  # TODO docstring
  ...
  if (merged_dict.get('use_dynamic_partitions') == 'true') and (
    ...
    merged_dynamic_partitions_dict = MergeDynamicPartitionInfoDicts(
  ...
  # TODO add more info on this? or move out of common?
  ...
  # loaded from target files for repacking. See LoadInfoDict().
