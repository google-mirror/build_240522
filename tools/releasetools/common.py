...
def _MakeRamdisk(sourcedir, fs_config_file=None, ramdisk_format=RamdiskFormat.LZ4):
  ...
  if ramdisk_format == RamdiskFormat.LZ4:
    ...
    raise ExternalError("Only support lz4 or minigzip ramdisk format.")
  ...
  if os.access(fn, os.F_OK):
    ...
    for ramdisk_fragment in ramdisk_fragments:
      ...
      if os.access(fn, os.F_OK):
        ...
        ramdisk_fragment_img = _MakeRamdisk(ramdisk_fragment_root, ramdisk_format=ramdisk_format)
