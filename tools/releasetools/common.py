...
def GetAvbPartitionsArg(partitions, resolve_rollback_index_location_conflict,
                        info_dict=None):
  ...
  # Handle non-chained AVB partitions, where the descriptors are included into
  # a vbmeta image directly.
  avb_args = []
