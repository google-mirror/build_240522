...
def _BuildBootableImage(image_name, sourcedir, fs_config_file, info_dict=None,
  ...
  if has_ramdisk:
    ramdisk_img = _MakeRamdisk(sourcedir, fs_config_file, lz4_ramdisks=info_dict.get("lz4_ramdisks"))
...
def _BuildVendorBootImage(sourcedir, info_dict=None):
  ...
  ramdisk_img = _MakeRamdisk(sourcedir, lz4_ramdisks=info_dict.get("lz4_ramdisks"))
