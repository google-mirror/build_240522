...
def LoadInfoDictsForReleaseTools(input_files):
...
def MergeDynamicPartitionInfoDicts(info_dicts):
  ...
  consistent, _ = is_value_consistent("use_dynamic_partitions")
  if not consistent:
  ...
  consistent, value = is_value_consistent("super_block_devices")
  if consistent:
    ...
    for block_device in merged_dict["super_block_devices"].split(" "):
      ...
      consistent, value = is_value_consistent(key)
      if not consistent:
