...
class BuildInfo(object):
  ...
  def __init__(self, info_dict, oem_dicts=None):
    ...
    if "system" in self._partition_fingerprints:
      # system_other is not included in AVB_PARTITIONS, but does need a
      # fingerprint when creating the image.
      self._partition_fingerprints[
    ...
    try:
      ...
      for partition in ["system", "vendor"]:
        self._fingerprint = self.GetPartitionFingerprint(partition)
