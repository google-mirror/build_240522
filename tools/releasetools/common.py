...
AVB_PARTITIONS = ('boot', 'dtbo', 'odm', 'product', 'recovery', 'system',
                  'system_ext', 'gms', 'vendor', 'vendor_boot')

# Chained VBMeta partitions.
AVB_VBMETA_PARTITIONS = ('vbmeta_system', 'vbmeta_vendor')

# Partitions that should have their care_map added to META/care_map.pb
PARTITIONS_WITH_CARE_MAP = ('system', 'vendor', 'product', 'system_ext', 'gms', 'odm')
...
def LoadInfoDict(input_file, repacking=False):
  ...
  if repacking:
    ...
    for part_name in ["system", "vendor", "system_ext", "gms", "product", "odm"]:
