...
def LoadInfoDict(input_file, input_dir=None):
  ...
  if input_dir is not None:
    ...
    # Similarly we need to redirect "ramdisk_dir, "root_dir", and "root_fs_config".
    d["ramdisk_dir"] = os.path.join(input_dir, "RAMDISK")
...
def LoadRecoveryFSTab(read_helper, fstab_version, recovery_fstab_path,
  ...
  # / is always used for the system mount point.
