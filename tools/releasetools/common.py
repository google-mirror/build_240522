...
def SignFile(input_name, output_name, key, password, codename_to_api_level_map=dict(),
    whole_file=False):
  ...
  if whole_file:
    ...
    cmd.extend(["--min-sdk-version",
                str(GetMinSdkVersionInt(input_name, codename_to_api_level_map))])
