...
class CommonUtilsTest(test_utils.ReleaseToolsTestCase):
  ...
  def test_CheckApkShareduidPartitionViolations(self):
    uid_dict = {
        'android.uid.phone': {
    ...
    errors = common.CheckApkShareduidPartitionViolations(
        uid_dict, [('system', 'system_ext'), ('vendor', 'odm')])
    self.assertEqual(errors, [])

  def test_CheckApkShareduidPartitionViolations_Violation(self):
    uid_dict = {
        'android.uid.phone': {
            'system': ['system_phone.apk'],
