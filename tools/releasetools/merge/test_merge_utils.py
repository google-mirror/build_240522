...
class MergeUtilsTest(test_utils.ReleaseToolsTestCase):
  ...
  def test_ValidateConfigLists_ReturnsFalseIfMissingDefaultItem(self):
  ...
  def test_ValidateConfigLists_ReturnsTrueIfDefaultItemInDifferentList(self):
    self.OPTIONS.framework_item_list = list(DEFAULT_FRAMEWORK_ITEM_LIST)
    ...
    self.assertTrue(merge_utils.ValidateConfigLists())

  def test_ValidateConfigLists_ReturnsTrueIfExtraItem(self):
    self.OPTIONS.framework_item_list = list(DEFAULT_FRAMEWORK_ITEM_LIST)
