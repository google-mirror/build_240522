...
"""
  ...
  def test_ReplaceGkiSigningKey(self):
    ...
    common.OPTIONS.gki_signing_extra_args = 'release_gki_extra_args'

    misc_info = {
        'gki_signing_key_path': 'default_gki_key',
        'gki_signing_algorithm': 'default_gki_algorithm',
        'gki_signing_extra_args': 'default_gki_extra_args',
    }
    expected_dict = {
        'gki_signing_key_path': 'release_gki_key',
        'gki_signing_algorithm': 'release_gki_algorithm',
        'gki_signing_extra_args': 'default_gki_extra_args release_gki_extra_args',
    }
