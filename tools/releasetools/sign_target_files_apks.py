...
def ProcessTargetFiles(input_tf_zip, output_tf_zip, misc_info,
  ...
  for info in input_tf_zip.infolist():
    ...
    # Custom images
          ...
          OPTIONS.avb_keys.get("custom_images") and
          OPTIONS.avb_algorithms.get("custom_images") and
      ...
      signed_custom_image = custom_images_utils.SignCustomImage(
          custom_image,
          OPTIONS.avb_keys.get("custom_images"),
          OPTIONS.avb_algorithms.get("custom_images"),
          OPTIONS.avb_extra_args.get("custom_images"))
...
def ReplaceMiscInfoTxt(input_zip, output_zip, misc_info):
  ...
  for key in sorted(misc_info):
    ...
    elif (key == "avb_custom_images_key_path" or
          key == "avb_custom_images_algorithm"):
      items.append('%s=%s' % (key, misc_info[key]))
