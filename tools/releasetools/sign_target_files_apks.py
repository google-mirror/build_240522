...
def ProcessTargetFiles(input_tf_zip, output_tf_zip, misc_info,
  ...
  for info in input_tf_zip.infolist():
    ...
    elif filename == "PRODUCT/etc/security/avb/system_other.avbpubkey":
      private_key = OPTIONS.avb_keys.get("system_other")
      if private_key:
        public_key = common.ExtractAvbPublicKey(private_key)
