...
def WriteMetadata(metadata_proto, output):
  ...
  Args:
    ...
    output: A ZipFile object or a string of the output file path, where the
        the metadata proto writes to.
  """
...
def GetPackageMetadata(target_info, source_info=None):
  ...
  # TODO(xunchang) some fileds, e.g. post-device isn't necessary. We can
