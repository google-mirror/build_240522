...
class PayloadGenerator(object):
  ...
  @staticmethod
  def _Run(cmd):  # pylint: disable=no-self-use
  ...
  def Sign(self, payload_signer):
    ...
    self.payload_file = payload_signer.SignPayload(self.payload_file)
    self.signed = True
  ...
  def WriteToZip(self, output_zip):
    ...
    assert self.signed, "Unsigned payload are not allowed to be written to zip"
