...
Flags:
  ...
  --additional_entries <filespec>
      Include additional entries into the generated zip file. The filespec
...
def main(argv):
  ...
  def option_handler(o, a):
    ...
    elif o == '--additional_entries':
      OPTIONS.additional_entries = shlex.split(a)
    else:
      return False
    return True
