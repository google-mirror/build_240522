...
class BlockImageDiffTest(unittest.TestCase):
  ...
  def test_ReviseStashSize(self):
    ...
    transfers = block_image_diff.transfers
    t1 = Transfer(
        "t1", "t1", RangeSet("11-15"), RangeSet("20-29"), "diff", transfers)
    t2 = Transfer(
        "t2", "t2", RangeSet("20-29"), RangeSet("11-15"), "diff", transfers)
  ...
  def test_ReviseStashSize_bug_33687949(self):
    ...
    transfers = block_image_diff.transfers
    t1 = Transfer(
        "t1", "t1", RangeSet("11-15"), RangeSet("1-5"), "diff", transfers)
    t2 = Transfer(
        "t2", "t2", RangeSet("21-25"), RangeSet("11-15"), "diff", transfers)
    t3 = Transfer(
        "t3", "t3", RangeSet("1-5 30-39"), RangeSet("11-15 30-39"), "diff", transfers)
