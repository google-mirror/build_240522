...
def _parse_args():
  ...
  parser.add_argument('--system-shared-lib-names', default='libc:libdl:libm',
                      help='System shared libraries to be hidden by default')
...
def main():
  ...
  system_shared_lib_names = {
    name for name in args.system_shared_lib_names.split(':') if name}
  checker.check_dt_needed(system_shared_lib_names)
