...
def _decorate_elf32_rel_info(cls):
    return _decorate_elf_rel_info(cls, 8, 0xff)


def _decorate_elf64_rel_info(cls):
    return _decorate_elf_rel_info(cls, 32, 0xffffffff)


Elf32_Rel = _decorate_elf32_rel_info(struct_class('Elf32_Rel', (
    ('r_offset', 'I'),
    ('r_info', 'I'),
)))


Elf64_Rel = _decorate_elf64_rel_info(struct_class('Elf64_Rel', (
    ('r_offset', 'Q'),
    ('r_info', 'Q'),
)))


Elf32_Rela = _decorate_elf32_rel_info(struct_class('Elf32_Rela', (
    ('r_offset', 'I'),
    ('r_info', 'I'),
    ('r_addend', 'i'),
)))
...
Elf64_Rela = _decorate_elf64_rel_info(struct_class('Elf64_Rela', (
    ('r_offset', 'Q'),
    ('r_info', 'Q'),
    ('r_addend', 'q'),
)))
...
def main():
    ...
    known_archs = {EM_386, EM_ARM, EM_X86_64, EM_AARCH64}
