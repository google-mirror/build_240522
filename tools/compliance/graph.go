...
type LicenseGraph interface {
	...
	// Targets returns a list of the target nodes in the graph.
	Targets() []TargetNode
...
type TargetNode interface {
	...
	// or target. e.g. SPDX-license-identifier-MIT or legacy_proprietary
	LicenseKinds() []string
	...
	// resolved is a matter of policy. e.g. notice or proprietary
...
type TargetEdgeAnnotations interface {
	...
	// AsList returns the list of string annotations in the set.
	AsList() []string
}
