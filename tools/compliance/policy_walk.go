...
// WalkTopDown and WalkTopDownBf. When VisitNode returns true, WalkTopDown will proceed to walk
...
// WalkTopDownBf performs a Breadth-first top down walk of `lg` calling `visit` and descending
// into depenencies when `visit` returns true.
