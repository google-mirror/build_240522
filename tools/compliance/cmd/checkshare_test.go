...
func Test(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedOutcomes: outcomeList{
				...
				&outcome{
					target:           "testdata/proprietary/highest.apex.meta_lic",
					privacyOrigin:    "testdata/proprietary/bin/bin2.meta_lic",
					privacyCondition: "proprietary",
					shareOrigin:      "testdata/proprietary/lib/libb.so.meta_lic",
					shareCondition:   "restricted",
				...
				&outcome{
					target:           "testdata/proprietary/highest.apex.meta_lic",
					privacyOrigin:    "testdata/proprietary/lib/libc.a.meta_lic",
					privacyCondition: "proprietary",
					shareOrigin:      "testdata/proprietary/lib/libb.so.meta_lic",
					shareCondition:   "restricted",
				},
		...
		},
		{
			...
			expectedOutcomes: outcomeList{
				...
				&outcome{
					target:           "testdata/proprietary/container.zip.meta_lic",
					privacyOrigin:    "testdata/proprietary/bin/bin2.meta_lic",
					privacyCondition: "proprietary",
					shareOrigin:      "testdata/proprietary/lib/libb.so.meta_lic",
					shareCondition:   "restricted",
		...
		},
		{
			...
			expectedOutcomes: outcomeList{
				&outcome{
					target:           "testdata/proprietary/application.meta_lic",
					privacyOrigin:    "testdata/proprietary/lib/liba.so.meta_lic",
					privacyCondition: "proprietary",
					shareOrigin:      "testdata/proprietary/lib/libb.so.meta_lic",
					shareCondition:   "restricted",
	...
	for _, tt := range tests {
		t.Run(tt.condition+" "+tt.name, func(t *testing.T) {
			...
			if err != nil && err.Error() != "conflicts" {
