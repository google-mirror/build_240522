...
var (
	...
	invert          = flag.Bool("invert", false, "Whether to group by target instead of origin")
...
func main() {
	...
	ctx := &context{append([]string{}, *conditions...), *graphViz, *invert, *labelConditions, *stripPrefix}
