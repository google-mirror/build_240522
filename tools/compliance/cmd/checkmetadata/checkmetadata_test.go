...
func Test(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			projects:       []string{"firstparty", "notice", "reciprocal", "restricted"},
		...
		},
		{
			...
			projects:       []string{"firstparty", "notice", "reciprocal", "restricted", "proprietary"},
		...
		},
		{
			...
			projects:       []string{"firstparty", "notice", "reciprocal", "restricted", "proprietary", "regressgpl1"},
		...
		},
		{
			...
			projects:       []string{"firstparty", "notice", "reciprocal", "restricted", "proprietary", "regressgpl1", "regressgpl2"},
		...
		},
		{
			...
			projects:       []string{"regressgpl2", "firstparty", "notice", "reciprocal", "restricted", "proprietary", "regressgpl1"},
			expectedStdout: "PASS -- parsed 5 project metadata files for 7 projects",
		},
		{
			name:           "missing2+1p+notice+missing1+reciprocal+restricted+proprietary",
			projects:       []string{"regressgpl2", "firstparty", "notice", "regressgpl1", "reciprocal", "restricted", "proprietary"},
			expectedStdout: "PASS -- parsed 5 project metadata files for 7 projects",
		},
	}
