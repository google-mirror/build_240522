...
func getDocumentName(ctx *context, tn *TargetNode, pm *projectmetadata.ProjectMetadata) string {
...
func getProjectMetadata(_ *context, pmix *projectmetadata.Index, tn *TargetNode) (*projectmetadata.ProjectMetadata, error) {
