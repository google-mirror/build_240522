...
type LicenseConditionSet interface {
	...
	// CountByName returns the number of conditons in the set matching `names`.
	...
	// CountByOrigin returns the number of conditons in the set that originate at `origin`.
