...
type LicenseConditionSet interface {
	...
	// AddSet makes each element of `conditions` a member of the set.
	AddSet(conditions LicenseConditionSet)

	// ByName returns all of the conditions in the set matching `names`.
	ByName(names ...ConditionNames) LicenseConditionSet
	...
	ByOrigin(origin TargetNode) LicenseConditionSet
