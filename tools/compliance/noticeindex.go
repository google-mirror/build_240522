...
// InputMetadataFiles returns the list of METADATA files that were read during IndexLicensetexts.
func (ni *NoticeIndex) InputMetadataFiles() []string {
	return ni.pmix.AllMetadataFiles()
}
