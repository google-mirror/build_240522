...
func (cs *licenseConditionSetImp) Conditions() ConditionList {
...
func (cs *licenseConditionSetImp) rename(treatAsAggregate bool, names ConditionNames, newName string) *licenseConditionSetImp {
...
// copy returns a new liceneseConditionSetImp containing all of the conditions in cs.
