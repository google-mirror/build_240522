...
# Find the repo root directory, searching upward from this script.
tool_dir = os.path.dirname(sys.argv[0])
repo_dir = os.path.realpath('%s/../../..' % tool_dir)

bionic_dir = '%s/bionic' % repo_dir
bionic_libc_tools_zoneinfo_dir = '%s/libc/tools/zoneinfo' % bionic_dir
...
icu_dir = '%s/external/icu4c' % repo_dir
