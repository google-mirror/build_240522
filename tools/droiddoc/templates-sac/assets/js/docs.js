...
$(document).ready(function() {
  ...
  $('body').keyup(function(event) {
    if (event.which == 191) {
      $('.search form.gsc-search-box td.gsc-input input.gsc-input').focus();
    }
  });
  ...
  $('.search .close').click(function() {
    $searchInput = $('.search form.gsc-search-box td.gsc-input input.gsc-input');
    $searchInput.attr('value', '');
    $(this).addClass("hide");
    $("#search-container").removeClass('active');
    $(".search form.gsc-search-box td.gsc-input input.gsc-input").blur();
...
function onSuggestionClick(link) {
  ...
  ga('send', 'event', 'Suggestion Click', 'clicked: ' + $(link).attr('href'),
                'query: ' + $(".search form.gsc-search-box td.gsc-input input.gsc-input").val().toLowerCase());
}
...
function search_changed(e, kd, toroot)
{
    ...
    var search = $("#search-container.search form.gsc-search-box td.gsc-input input.gsc-input")[0];
...
function hideResults() {
  ...
  $(".search form.gsc-search-box td.gsc-input input.gsc-input").val("").blur();

  // reset the ajax search callback to nothing, so results don't appear unless ENTER
  searchControl.setSearchStartingCallback(this, function(control, searcher, query) {});

  // forcefully regain key-up event control (previously jacked by search api)
  $("#search-container.search form.gsc-search-box td.gsc-input input.gsc-input").keyup(function(event) {
...
var myCallback = function() {
  ...
  //Set up search
  $(".search form.gsc-search-box td.gsc-input input.gsc-input").focus(function() {
  ...
  $("#search-container").mouseout(function() {
    if ($(".search form.gsc-search-box td.gsc-input input.gsc-input").is(":focus")) return;
    if ($(".search form.gsc-search-box td.gsc-input input.gsc-input").val() == '') {
      setTimeout(function(){
        $("#search-container").removeClass('active');
        $(".search form.gsc-search-box td.gsc-input input.gsc-input").blur();
      },250);
  ...
  $(".search form.gsc-search-box td.gsc-input input.gsc-input").blur(function() {
    if ($(".search form.gsc-search-box td.gsc-input input.gsc-input").val() == '') {
      $("#search-container").removeClass('active');
    }
  })
...
(function() {
  var cx = '001482626316274216503:zu90b7s047u'; // Insert your own Custom Search Engine ID here
