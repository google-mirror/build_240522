...
# Usage:
#   print-exporting-java-module-descriptor <module-name> <java-file>*
#
# Prints the contents of a module descriptor (module-info.java) to
# stdout that exports the package of every <java-file>.
#
...
def packages(paths):
  result = Set([])
  dirs_done = Set([])
  pattern = re.compile("^package ([a-zA-Z0-9\.]+);")
  for path in paths:
...
def main(args):
  create_module_info("java.base", packages(args))
