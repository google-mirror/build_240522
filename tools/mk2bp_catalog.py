...
def main():
  ...
  # need to set the out_dir to be an absolute path before os.chdir line below
  # in case the out_dir is set as a relative path, such as '.' at out/ directory
  # then out_dir would use the root directory rather than the out/ directory.
