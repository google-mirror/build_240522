...
# (1) 'project' maps a project name to number of warnings in that project.
# (2) 'projectanchor' maps a project name to its anchor number for HTML.
# (3) 'byproject' maps a project name to a list of warning of that proejct.
...
def dumpcategorybyproject(sev, cat):
    ...
    projects = cat['byproject'].keys()
    projects.sort()
    for p in projects:
        anchor = cat['projectanchor'][p]
        projectwarnings = cat['byproject'][p]
    ...
    for i in warnpatterns:
        for cpat in i['compiledpatterns']:
            if cpat.match(line):
                ...
                if args.byproject:
                    if pname in i['byproject']:
                        i['byproject'][pname].append(line)
                    else:
                        i['byproject'][pname] = [line]
