...
warn_patterns = [
    ...
    {'category': 'google_tests', 'severity': Severity.HARMLESS,
     'description': 'google_tests: unknwon installed file',
    ...
    {'category': 'C/C++', 'severity': Severity.TIDY,
     ...
     'patterns': [r".*: .+\[google-.+\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-explicit-conversions',
     'patterns': [r".*: .+\[hicpp-explicit-conversions\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-function-size',
     'patterns': [r".*: .+\[hicpp-function-size\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-invalid-access-moved',
     'patterns': [r".*: .+\[hicpp-invalid-access-moved\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-member-init, uninitialized fields',
     'patterns': [r".*: .+\[hicpp-member-init\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-new-delete-operators',
     'patterns': [r".*: .+\[hicpp-new-delete-operators\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-special-member-functions',
     'patterns': [r".*: .+\[hicpp-special-member-functions\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-use-equals-default',
     'patterns': [r".*: .+\[hicpp-use-equals-default\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-use-equals-delete',
     'patterns': [r".*: .+\[hicpp-use-equals-delete\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-no-assembler',
     'patterns': [r".*: .+\[hicpp-no-assembler\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-noexcept-move',
     'patterns': [r".*: .+\[hicpp-noexcept-move\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp-use-override',
     'patterns': [r".*: .+\[hicpp-use-override\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy hicpp- other',
     'patterns': [r".*: .+\[hicpp-.+\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
    ...
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy performance-inefficient-string-concatenation',
     'patterns': [r".*: .+\[performance-inefficient-string-concatenation\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
     'description': 'clang-tidy performance-type-promotion-in-math-fn',
     'patterns': [r".*: .+\[performance-type-promotion-in-math-fn\]$"]},
    {'category': 'C/C++', 'severity': Severity.TIDY,
