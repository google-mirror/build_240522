...
warnpatterns = [
    ...
    { 'category':'C/C++',   'severity':severity.MEDIUM,   'members':[], 'option':'-W#pragma-messages',
    ...
    { 'category':'C/C++',   'severity':severity.MEDIUM,     'members':[], 'option':'-Wunnamed-type-template-args',
        'description':'Unnamed template type argument',
        'patterns':[r".*: warning: template argument.+unnamed-type-template-args"] },
