...
def project_name_and_pattern(n, p):
  return [n, '(^|.*/)' + p + '/.*: warning:']


def simple_project_pattern(p):
  return project_name_and_pattern(p, p)
...
project_list = [
    ...
    project_name_and_pattern('out/obj', '.*/(gen|obj[^/]*)/'
                             '(include|EXECUTABLES|SHARED_LIBRARIES|'
