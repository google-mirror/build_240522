...
warn_patterns = [
    ...
    {'category': 'java',
     'severity': severity.LOW,
     'description':
         'Java: In Google Style, unlike Android Style, field names with special prefixes like mName and sName are not used.  Google3 Android code must follow Google Style.',
     'patterns': [r".*: warning: \[FieldPrefixes\] .+"]},
    {'category': 'java',
     'severity': severity.LOW,
     'description':
    ...
    {'category': 'java',
     'severity': severity.LOW,
     'description':
         'Java: Add @NanoEnumValue(Enum.class) where intdef @Enum is found',
     'patterns': [r".*: warning: \[AddNanoEnumValue\] .+"]},
    {'category': 'java',
     'severity': severity.LOW,
     'description':
         'Java: Create variables to build submessages where necessary and possible',
     'patterns': [r".*: warning: \[AddSubmessageBuilders\] .+"]},
    {'category': 'java',
     'severity': severity.LOW,
     'description':
         'Java: Annotate immutable nanos where possible',
     'patterns': [r".*: warning: \[ImmutabilityAnnotations\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: Do not call `Flow.getEntityKey().getContainerKey()`, use `Flow.getTargetContainerKey()` instead.',
     'patterns': [r".*: warning: \[FlowGetContainerKey\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: Guice malpractice - the Guice Modules.override() method should not be used.',
     'patterns': [r".*: warning: \[GuiceModulesOverride\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: Guice malpractice - the Guice @Named annotation should not be used.',
     'patterns': [r".*: warning: \[GuiceNamedAnnotation\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
    ...
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: Ban temporary state inside Arcus entities.',
     'patterns': [r".*: warning: \[NonStaticFieldInEntity\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
    ...
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: Starting with Android O, apps won\'t be allowed to start services in background. android.content.Context#startService(Intent) or com.google.android.apps.gsa.shared.util.ContextUtils#checkedStartService(Context, Intent) should only be called when the app is surely in foreground, i.e there is a resumed activity/foreground service with notification etc. Binding to service should be preferred in all other cases. Handing over android.app.PendingIntent with android.app.PendingIntent#getService(Context, int, Intent, int) may be fine with notifications but may not be in other cases. See go/agsa-o-services-migration and go/o-bkgd-chk-eng-spec for more information. Please reach out to agsa-services@ for help.',
     'patterns': [r".*: warning: \[StartServiceChecker\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: Checks for modifications to VelvetStates annotated with @Global, @MostlyGlobal, @MostlySession, or @MostlyQuery and outputs a warning.',
     'patterns': [r".*: warning: \[VelvetStateAnnotationChecker\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: android.widget.Toast does not work on all versions of Android. Watch out for Toasts API or other library provided by Velour team in the future.',
     'patterns': [r".*: warning: \[NoReferenceToToastChecker\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
    ...
    {'category': 'java',
     ...
     'patterns': [r".*: warning: \[DoNotMock_ForTricorder\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
    ...
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: "produce" methods in ProducerModule classes must be annotated with @Produces',
     'patterns': [r".*: warning: \[ProduceMethodShouldBeAnnotated\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: "provide" methods in Guice Module classes must be annotated with @Provides',
     'patterns': [r".*: warning: \[ProvideMethodShouldBeAnnotated\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
    ...
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: Applies @NanoEnumValue to ints that look like enums',
     'patterns': [r".*: warning: \[EnumAnnotations\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: A deprecated GSA version is referred to in the code',
     'patterns': [r".*: warning: \[DeprecatedNowClientVersionChecker\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: Using offsets can affect the latency of the query, and may cause your application to be charged more. Avoid using offsets.',
     'patterns': [r".*: warning: \[AvoidDatastoreOffsets\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: This method creates a Datastore Query object and calls methods on the result Entity objects that only require the keys and not the entities themselves. Call .setKeysOnly() on the Query for improved performance.',
     'patterns': [r".*: warning: \[MissingSetKeysOnly\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: Having dots in property names will interfere with EmbeddedEntity property queries once they are supported.',
     'patterns': [r".*: warning: \[NoDotsInPropertyName\] .+"]},
    {'category': 'java',
     'severity': severity.MEDIUM,
     'description':
         'Java: This method calls setKeysOnly() on a Datastore Query object but calls methods on the result Entity objects that require the entities themselves and not just the keys. Remove the setKeysOnly() call.',
     'patterns': [r".*: warning: \[OmitQueryAndSetKeysOnly\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: All actions should be annotated with @AcceptableScopes',
     'patterns': [r".*: warning: \[ActionRequiresAcceptableScopesChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: All actions should be annotated with @FamilyMemberRequired',
     'patterns': [r".*: warning: \[ActionRequiresFamilyMemberChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: @Beta APIs should not be used in library code as they are subject to change',
     'patterns': [r".*: warning: \[BetaApi\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: @GoogleInternal APIs should not be used in code that is to be released publicly',
     'patterns': [r".*: warning: \[GoogleInternalApi\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Incorrect type for injected experiment value.',
     'patterns': [r".*: warning: \[ExperimentInjectionTypeChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Please don\'t use Messenger. See go/shoot-the-messenger',
     'patterns': [r".*: warning: \[ShootTheMessenger\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Constructing an `EndOfFlowOutcome` with output type `T` is only allowed within a `FlowType` or `ExtraFlowSteps` parameterized with that output type (eg.`EndOfFlowOutcome.withOutput(T)` may only be called within a `FlowType\u003c?, ?, ?, T>` or `ExtraFlowSteps\u003c?, ?, ?, T>`).',
     'patterns': [r".*: warning: \[FlowOutputTypeCheck\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Disallow `getBuilder()` in Entity constructors with EntityData.',
     'patterns': [r".*: warning: \[GetBuilderInEntityConstructor\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: FlowType and ExtraFlowSteps may not be nested inside other FlowTypes or ExtraFlowSteps',
     'patterns': [r".*: warning: \[NestedFlowTypes\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: The getRequiredPermissions() method must never return an empty set.',
     'patterns': [r".*: warning: \[GetRequiredPermissionsEmptySet\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Methods annotated with @IamPermissions must return an ImmutableList\u003cIamPermission>.',
     'patterns': [r".*: warning: \[IamPermissionsReturnType\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Actions must either implement Authorizable, have an @IamPermissions method, or be marked as internal by @SkipCloudIamAclChecks or @ImplementsCustomAuthorizationRule.',
     'patterns': [r".*: warning: \[ImplementsActionButNotAuthorizable\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Actions must not be annotated with both @SkipCloudIamAclChecks and @ImplementsCustomAuthorizationRule.',
     'patterns': [r".*: warning: \[MultipleAuthorizationBypassAnnotations\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Actions must either have an @OrgConstraints method or be marked as @SkipOrgConstraintsChecks. Method annotated with @OrgConstraints must return an ImmutableList\u003cOrgConstraint>.If your build is failing, that is because your target is taking direct dependency on "cloud/cluster/api:compute java proto". Fix it by one of following ways: 1. If your action take direct dependency on "cloud/cluster/api:compute java proto", please follow cr/159032149 to avoid action from org costraints checks. 2. If your Action doesn\'t take direct dependency on "cloud/cluster/api:compute java proto" then move it to a separate target.',
     'patterns': [r".*: warning: \[OrgConstraintsConformance\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: forInjectedClassName should not be used directly; use forEnclosingClass instead',
     'patterns': [r".*: warning: \[GoogleLoggerUsage\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Enforce app metadata methods are invoked using Wrappers API',
     'patterns': [r".*: warning: \[InstantAppWrappers\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Your key operation is heavy weighted, in many cases, you don\'t really need that. Consider using a light weight alternative or pre calculate the value if possible. But if the change is really necessary, add @SuppressWarnings("HeavyKeyOperationChecker") to your code.',
     'patterns': [r".*: warning: \[HeavyKeyOperationChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: State classes should lazily inject into other states',
     'patterns': [r".*: warning: \[LazyStateInjectionChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: SearchResult should only contain the content, should not do the logging inside.',
     'patterns': [r".*: warning: \[NoLoggingInSearchResultChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: GSA code is not allowed to create a new java.lang.Thread! Use com.google.android.apps.gsa.shared.util.concurrent.TaskRunner or com.google.android.apps.gsa.shared.util.concurrent.TaskRunnerExecutors instead.',
     'patterns': [r".*: warning: \[NoNewThreadChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Usage of android.util.Log methods are not allowed in AGSA. Use com.google.android.apps.gsa.shared.util.common.L instead. NOTE: Be sure to enable your tag using \'adb shell setprop log.tag.MyClassTag DEBUG\' (go/agsa-debug-logging)',
     'patterns': [r".*: warning: \[NoReferenceToLogChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: All AGSA Service classes must inherit from either GsaBaseService or GsaBaseIntentService.',
     'patterns': [r".*: warning: \[ServiceBaseClassChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: In AGSA, SearchServiceStarter#sendOneOffGenericClientEventInForeground(..) method calls android.content.Context#startService(Intent) which will be restricted in Android O. Starting with Android O, apps won\'t be allowed to start services in background. Please use this method only when the app is surely in foreground, i.e there is a resumed activity/foreground service with notification etc. Prefer binding to service in other cases. See go/agsa-o-services-migration for more information. If you are certain that this method is called from foreground, please add @SuppressWarnings("StartSearchServiceInForegroundChecker") to your code. Also, please cc agsa-services@ to your CL.',
     'patterns': [r".*: warning: \[StartSearchServiceInForegroundChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: GSA code is not allowed to use a TAG longer than 23 chars.  A TAG longer than this cannot be set with "adb shell setprop log.tag.ExcessivelyLongTagBlahBlah"',
     'patterns': [r".*: warning: \[TagLengthChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Velour jars are not allowed to use android.app.Fragment! Use com.google.android.libraries.velour.api.DynamicFragment instead.',
     'patterns': [r".*: warning: \[NoDeriveFromFragmentChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Velour jars are not allowed to create a new java.lang.Thread! Use com.google.android.apps.gsa.shared.util.concurrent.TaskRunner instead.',
     'patterns': [r".*: warning: \[VelourNoNewThreadChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Injection types imported in GWS must be compatible with Dagger.',
     'patterns': [r".*: warning: \[BadInjectionImportChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Blocking calls are forbidden in GWS.',
     'patterns': [r".*: warning: \[BlockingCall\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Modules in GWS plugin subpackages must be public.',
     'patterns': [r".*: warning: \[PublicModule\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Direct access to the GenericSearchResponse result array is forbidden in non-test GWS code. See go/result-array-alternatives for other options, or, if this is test code, apply the annotation @AllowResultArrayAccess(justification = "Test code.") to the method. See com.google.gws.framework.AllowResultArrayAccess.',
     'patterns': [r".*: warning: \[ResultAccessorChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: @Provides methods must be static in GWS.',
     'patterns': [r".*: warning: \[StaticProvidesChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Expression passed to GWT SafeHtml API method does not satisfy required contract. See JavaDoc for details.',
     'patterns': [r".*: warning: \[SafeHtmlMisuse\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Static and default interface methods are not natively supported on older Android devices. Suppress this error to opt into the newly added build support for interface methods but please read go/default-methods-for-android-faq first.',
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: @FlagGenerator methods need to live within @FlagInterface interfaces',
     'patterns': [r".*: warning: \[FlagGeneratorOutsideOfFlagInterface\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: FlagSpec has altName specified which is redundant',
     'patterns': [r".*: warning: \[FlagSpecWithRedundantAltName\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Flags must be annotated with @FlagSpec to work properly',
     'patterns': [r".*: warning: \[FlagWithoutFlagSpec\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Invalid printf-style format string',
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Internal errors in the GwtAnnotationTypeChecker',
     'patterns': [r".*: warning: \[SafeHtmlAnnotationTypeChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: GWT @SuppressIs...CastCheck not allowed here.',
     'patterns': [r".*: warning: \[SafeHtmlPluggableTypeSuppressionAnnotationWhitelistChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Argument to TunnelException.tunnel must be a lambda or method reference so Error Prone can identify the exception types thrown.',
     'patterns': [r".*: warning: \[TunnelArgumentMustBeLambdaOrMethodReference\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Arguments to TunnelException.getCauseAs and TunnelException.rethrow must be checked exception class literals.',
     'patterns': [r".*: warning: \[TunnelExceptionArgsMustBeCheckedExceptionClassLiterals\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: All exception types thrown in TunnelException.tunnel lambdas must be caught and handled properly in the corresponding catch block.',
     'patterns': [r".*: warning: \[TunnelExceptionArgsMustMatchTunneledExceptions\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: A TunnelException must be caught in the same method in which it is thrown.',
     'patterns': [r".*: warning: \[TunnelExceptionMustBeCaught\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Unsafe HTML expression passed to SafeHtmlExpressions conversions API',
     'patterns': [r".*: warning: \[SafeHtmlExpressionsConversion\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Not approved use of SafeHtmlUtils.fromTrustedString API detected',
     'patterns': [r".*: warning: \[TrustedStringChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Hibernate\'s createQuery and createSQLQuery should not be used in non-test code.  Annotate any javatests with @SuppressHibernateCreateQueryChecker to suppress warnings for unit tests.',
     'patterns': [r".*: warning: \[HibernateCreateQueryChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: Ensure @MigrateAs annotations conform to usage restrictions',
     'patterns': [r".*: warning: \[ConsistentImmutabilityAnnotations\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
    ...
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
         'Java: A possibly-insecure inline URL is added to the proto.  The URL must be https and hosted at Google.  To verify this at compile time, the URL being added to the proto must be either a variable ending in privateUrl or PRIVATE URL; or must be the return value of UrlPrivacy.ensurePrivateUrl(String).',
     'patterns': [r".*: warning: \[InlineUrlPrivacyChecker\] .+"]},
    {'category': 'java',
     'severity': severity.HIGH,
     'description':
