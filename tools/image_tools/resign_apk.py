...
execute('sudo DEFAULT_SYSTEM_DEV_CERTIFICATE=' + build_top + key_path_prefix + ' \\system/sepolicy/tools/insertkeys.py -c . -o ' + mount_dir + 'system/etc/selinux/plat_mac_permissions.xml system/sepolicy/private/keys.conf system/sepolicy/private/mac_permissions.xml')
