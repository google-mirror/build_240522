...
TEST_F(UncompressedSharedLibsTest, Aligned_PageSize_4kB) {
  int pageSize = 4096;
...
TEST_F(UncompressedSharedLibsTest, Aligned_PageSize_16kB) {
  int pageSize = 16384;
...
TEST_F(UncompressedSharedLibsTest, Aligned_PageSize_64kB) {
  int pageSize = 65536;
