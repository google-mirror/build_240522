 ...
 * - alignTo: Alignment units for uncompressed entries.
 * - force  : Overwrite output if it exists, fail otherwise.
 * - pageAlignSharedLibs: Align .so on 4096, or alignTo if false.
 ...
 * - alignTo: Alignment boundary for uncompressed entries.
 * - pageAlignSharedLibs: .so must be aligned to 4096, or alignTo if false.
 *
 * Returns 0 on success.
 */
