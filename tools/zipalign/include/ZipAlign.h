 ...
 * - padTo: pad file to be sized of multiples of padTo.
...
int process(const char* input, const char* output, int alignTo, bool force,
    int padTo, bool zopfli, bool pageAlignSharedLibs);
 ...
 * Returns 0 on success.
 */
int verify(const char* fileName, int alignTo, int padTo, bool verbose,
