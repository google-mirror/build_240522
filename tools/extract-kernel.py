...
"""
A tool to extract kernel configuration from a kernel image.
"""
...
def main():
    ...
    if args.output_configs is not None:
        ...
        if o:
            ...
            sys.stderr.write("Cannot extract kernel configs in {}".format(ars.input.name))
            ret = 1
    if args.output_version is not None:
        ...
        if o:
            ...
            sys.stderr.write("Cannot extract kernel versions in {}".format(ars.input.name))
            ret = 1
