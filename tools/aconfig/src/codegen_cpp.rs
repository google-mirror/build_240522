...
// FIXME: rename parsed_flags to iter or parsed_flags_iter (apply fix to java, cpp and rust)
pub fn generate_cpp_code<'a, I>(package: &str, parsed_flags: I) -> Result<OutputFile>
where
    I: Iterator<Item = &'a ProtoParsedFlag>,
{
    let class_elements: Vec<ClassElement> =
        parsed_flags.map(|pf| create_class_element(package, pf)).collect();
