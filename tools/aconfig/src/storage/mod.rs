...
mod tests {
    ...
    pub fn parse_all_test_flags() -> Vec<ProtoParsedFlags> {
        let aconfig_files = [
            ("com.android.aconfig.storage.test_1", "storage_test_1.aconfig",
             include_bytes!("../../tests/storage_test_1.aconfig").as_slice()),
            ("com.android.aconfig.storage.test_1", "storage_test_2.aconfig",
             include_bytes!("../../tests/storage_test_2.aconfig").as_slice()),
            ("com.android.aconfig.storage.test_2", "storage_test_3.aconfig",
             include_bytes!("../../tests/storage_test_3.aconfig").as_slice()),
        ];
