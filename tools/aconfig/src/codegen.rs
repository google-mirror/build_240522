...
pub fn is_valid_container_ident(s: &str) -> bool {
    s.is_empty() || is_valid_name_ident(s) || s.split('.').all(is_valid_name_ident)
}
...
mod tests {
    ...
    fn test_is_valid_container_ident() {
        ...
        // TODO(b/312769710): Do not allow empty strings as a container identifier, once all
        // existing flag declarations have been assigned to a container.
