...
pub fn generate_java_code(cache: &Cache) -> Result<Vec<OutputFile>> {
    ...
    template.add_template("FeatureFlagsImpl.java", include_str!("../templates/FeatureFlagsImpl.java.template"))?;
    template.add_template("FeatureFlags.java", include_str!("../templates/FeatureFlags.java.template"))?;
...
mod tests {
    ...
    fn test_generate_java_code() {
        ...
        public final class Flags {
            public static final String FLAG_DISABLED_RO = "com.android.aconfig.test/disabledRo";
            public static final String FLAG_DISABLED_RW = "com.android.aconfig.test/disabledRw";
            public static final String FLAG_ENABLED_RO = "com.android.aconfig.test/enabledRo";
            public static final String FLAG_ENABLED_RW = "com.android.aconfig.test/enabledRw";
