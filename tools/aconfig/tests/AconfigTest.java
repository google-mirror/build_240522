...
import static com.android.aconfig.test2.Flags.exportedFlag;
import static com.android.aconfig.test2.Flags.FLAG_EXPORTED_FLAG;
...
public final class AconfigTest {
    ...
    public void testExportedFlag() {
        assertEquals("com.android.aconfig.test2.exported_flag", FLAG_EXPORTED_FLAG);
