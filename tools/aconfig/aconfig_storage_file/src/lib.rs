...
mod tests {
    ...
    fn test_list_flag() {
        ...
        let expected = [
            ...
            (String::from("com.android.aconfig.storage.test_1"), String::from("disabled_rw"), false),
            (String::from("com.android.aconfig.storage.test_2"), String::from("disabled_ro"), false),
            (String::from("com.android.aconfig.storage.test_2"), String::from("enabled_fixed_ro"), true),
            ...
            (String::from("com.android.aconfig.storage.test_4"), String::from("enabled_fixed_ro"), false),
        ];
