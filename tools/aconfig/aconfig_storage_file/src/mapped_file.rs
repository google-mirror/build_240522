...
fn map_container_storage_files(
    ...
    // note the Mmap::map call returns a Result, if the passed in file location
    // is invalid, the Mmap::map call will fail. And we will return an error here.
    // this error will be handled by the calling client.
