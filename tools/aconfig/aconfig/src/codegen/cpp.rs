...
fn create_class_element(package: &str, pf: &ProtoParsedFlag, flag_ids: HashMap<String, u16>, rw_count: &mut i32) -> ClassElement {
    ClassElement {
...
"#;
    ...
    fn test_generate_cpp_code(
        ...
        let generated =
            generate_cpp_code(crate::test::TEST_PACKAGE, modified_parsed_flags.into_iter(), mode, flag_ids, allow_instrumentation)
                .unwrap();
