...
/*                     *** DO NOT CHANGE ***
** All "android_filestem_config.h" references in this file are candidates
** for generation/replacement to a device-specific version. Do not alter
** as this will break the customization. */
...
static void usage() {
  fprintf(stderr,
    ...
    "from device-specific %s override\n\n"
