...
#define NO_ANDROID_DEVICE_DIRS 1
#define NO_ANDROID_DEVICE_FILES 1
#endif

#ifdef NO_ANDROID_DEVICE_DIRS
static const struct fs_path_config android_device_dirs[] = {
};
#endif

#ifdef NO_ANDROID_DEVICE_FILES
...
static void usage() {
  fprintf(stderr, "Usage: fs_config_generate -D|-F [-o output-file]\n");
}
