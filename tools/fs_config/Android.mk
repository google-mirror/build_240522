...
#
# If TARGET_FS_CONFIG_GEN is set, we generate the header
# file from the intermediate.
#
ifneq ($(TARGET_FS_CONFIG_GEN),)
##################################
include $(CLEAR_VARS)

LOCAL_MODULE := android_filesystem_config.h
...
$(LOCAL_BUILT_MODULE): $(TARGET_FS_CONFIG_GEN) $(LOCAL_PATH)/fs_config_generator.py
	@mkdir -p $(dir $@)
	$(hide) $(PRIVATE_LOCAL_PATH)/fs_config_generator.py $(PRIVATE_TARGET_FS_CONFIG_GEN) > $@
my_fs_config_h := $(LOCAL_BUILT_MODULE)

endif # End TARGET_FS_CONFIG_GEN
