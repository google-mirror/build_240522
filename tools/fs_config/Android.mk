...
ifneq ($(TARGET_FS_CONFIG_GEN),)
LOCAL_GENERATED_SOURCES := $(local-generated-sources-dir)/$(ANDROID_FS_CONFIG_H)
$(LOCAL_GENERATED_SOURCES): PRIVATE_TARGET_FS_CONFIG_GEN := $(TARGET_FS_CONFIG_GEN)
$(LOCAL_GENERATED_SOURCES): PRIVATE_TARGET_FS_CONFIG_GEN_SCRIPT := $(LOCAL_PATH)/fs_config_generator.py
$(LOCAL_GENERATED_SOURCES): $(TARGET_FS_CONFIG_GEN) $(LOCAL_PATH)/fs_config_generator.py
	$(PRIVATE_TARGET_FS_CONFIG_GEN_SCRIPT) $(PRIVATE_TARGET_FS_CONFIG_GEN) > $@

my_fs_config_h := $(LOCAL_GENERATED_SOURCES)
endif
