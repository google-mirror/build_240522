...
my_target_fs_config_gen := $(TARGET_FS_CONFIG_GEN)
else
my_target_fs_config_gen := /dev/null
endif
...
$(LOCAL_BUILT_MODULE): PRIVATE_TARGET_FS_CONFIG_GEN := $(my_target_fs_config_gen)
$(LOCAL_BUILT_MODULE): $(LOCAL_PATH)/fs_config_generator.py $(my_target_fs_config_gen) $(system_android_filesystem_config) $(system_capability_header)
	@mkdir -p $(dir $@)
	$< fsconfig \
...
$(LOCAL_BUILT_MODULE): PRIVATE_TARGET_FS_CONFIG_GEN := $(my_target_fs_config_gen)
$(LOCAL_BUILT_MODULE): PRIVATE_ANDROID_FS_HDR := $(system_android_filesystem_config)
$(LOCAL_BUILT_MODULE): $(LOCAL_PATH)/fs_config_generator.py $(my_target_fs_config_gen) $(system_android_filesystem_config)
	@mkdir -p $(dir $@)
