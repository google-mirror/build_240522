...
def parse_args(argv) -> argparse.Namespace:
    ...
    parser.add_argument(
        '--android_build_top', help='value of ANDROID_BUILD_TOP')
    parser.add_argument(
        '--android_product_out', help='value of ANDROID_PRODUCT_OUT')
    parser.add_argument('--src_teams_file', help='location of input proto')
    parser.add_argument('--module_info', help='location of module-info.json')
    parser.add_argument('--out_file', help='location of final out file')
    # parser.add_argument(
    # '--add_files',
...
def main(argv):
    ...
    all_teams = read_team_proto_file(args.src_teams_file)

    if args.filter_teams:
        test_modules = read_module_info(args.module_info)
