...
succeeded and that the subset of projects didn not provide any internal APIs.
An app built against the SDK will also have its dex file inside its apk, which
