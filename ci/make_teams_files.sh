...
# BUILD the targets we need here rather than in the gcl config.
TARGET_PRODUCT=aosp_x86_64 TARGET_RELEASE=trunk_staging build/soong/soong_ui.bash --make-mode all_teams filter_teams
