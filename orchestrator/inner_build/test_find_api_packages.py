...
from find_api_packages import read, BazelLabel, ApiPackageFinder, \
        ApiPackageNotFoundException, ApiPackageDecodeException, ContributionData
...
class TestApiPackageFinder(unittest.TestCase):
    ...
    def test_exception_if_api_pacakge_file_is_missing(self, find_mock):
        find_mock.return_value = [] # no files found
        api_package_finder = ApiPackageFinder("mock_inner_tree")
        self.assertRaises(ApiPackageNotFoundException,
    ...
    def test_exception_if_api_domain_not_found(self, find_mock, read_mock):
        ...
        read_mock.return_value = ContributionData("com.android.foo",
                                                  BazelLabel("//packages/modules/foo",
                                                             "contributions"))
        api_package_finder = ApiPackageFinder("mock_inner_tree")
        self.assertRaises(ApiPackageNotFoundException, api_package_finder.find_api_label_string,
                          "system")
