...
class TestStringMethods(unittest.TestCase):
    ...
    def test_find_dirs(self):
        self.assertEqual([x for x in lunch_helper.FindDirs("test/configs", "multitree_combos")], [
    ...
    def test_find_file(self):
        ...
        self.assertEqual(lunch_helper.FindFile("test/configs", "v.mcombo"),
                   "test/configs/device/aa/bb/multitree_combos/v.mcombo")

    def test_find_config_dirs(self):
        self.assertEqual([x for x in lunch_helper.FindConfigDirs("test/configs")], [
                    "test/configs/build/make/orchestrator/multitree_combos",
                    "test/configs/vendor/aa/bb/multitree_combos",
                    "test/configs/device/aa/bb/multitree_combos"])
    ...
    def test_config_cycles(self):
        ...
        with self.assertRaises(lunch_helper.ConfigException) as context:
            lunch_helper.LoadConfig("test/configs/parsing/cycles/1.mcombo")
        self.assertEqual(context.exception.kind, lunch_helper.ConfigException.ERROR_CYCLE)

    def test_config_merge(self):
        # Test the merge logic
        self.assertEqual(lunch_helper.LoadConfig("test/configs/parsing/merge/1.mcombo"), {
                            "in_1": "1",
                            "in_1_2": "1",
                            "merged": {"merged_1": "1",
                                "merged_1_2": "1",
    ...
    def test_list(self):
        self.assertEqual(sorted(lunch_helper.FindAllLunchable("test/configs")),
                ["test/configs/build/make/orchestrator/multitree_combos/b.mcombo"])
