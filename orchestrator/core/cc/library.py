...
# TODO: Use the hermetic clang binaries
CLANG_BIN="/usr/bin/clang"
CLANG_CC_BIN="/usr/bin/clang++"

class CompileContext():

    def __init__(self, src: str, flags:str, out: str, frontend=CLANG_BIN):
        self.src = src
        self.flags = flags
        self.out = out
...
class LinkContext():
    ...
    def __init__(self, objs: List[str], flags: str, out: str, frontend=CLANG_CC_BIN):
        self.objs = objs
        self.flags = flags
        self.out = out
        self.frontend = frontend
