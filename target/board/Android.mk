...
# Install $(src) to /odm/etc/vintf/manifest_$(sku).xml
# $(1): sku
define _add_odm_manifest
...
include $$(CLEAR_VARS)
LOCAL_MODULE := odm_manfiest_$(1).xml
...
$(foreach sku, $(ODM_MANIFEST_SKUS), $(eval $(call _add_odm_manifest,$(sku))))
_add_odm_manifest :=

include $(CLEAR_VARS)
LOCAL_MODULE := odm_sku_manifests
LOCAL_REQUIRED_MODULES := $(foreach sku, $(ODM_MANIFEST_SKUS),odm_manifest_$(sku).xml)
