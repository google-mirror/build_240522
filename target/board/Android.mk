...
LOCAL_REQUIRED_MODULES := framework_compatibility_matrix_sources
...
$(GEN): $(FRAMEWORK_COMPATIBILITY_MATRIX_SRC_FILES) $(HOST_OUT_EXECUTABLES)/assemble_vintf
	PRODUCT_ENFORCE_VINTF_MANIFEST=$(PRODUCT_ENFORCE_VINTF_MANIFEST) \
		$(HOST_OUT_EXECUTABLES)/assemble_vintf \
		-i $(call normalize-path-list,$(FRAMEWORK_COMPATIBILITY_MATRIX_SRC_FILES)) \
		-o $@ $(PRIVATE_FLAGS)
LOCAL_PREBUILT_MODULE_FILE := $(GEN)
include $(BUILD_PREBUILT)
