...
$(GEN): PRIVATE_VNDK_VERSION := $(PLATFORM_VNDK_VERSION)
else
$(GEN): PRIVATE_VNDK_VERSION := $(BOARD_VNDK_VERSION)
endif

$(GEN): $(DEVICE_MATRIX_FILE) $(HOST_OUT_EXECUTABLES)/assemble_vintf
	REQUIRED_VNDK_VERSION=$(PRIVATE_VNDK_VERSION) \
...
$(GEN): $(FRAMEWORK_MANIFEST_INPUT_FILES) $(HOST_OUT_EXECUTABLES)/assemble_vintf
	BOARD_SEPOLICY_VERS=$(BOARD_SEPOLICY_VERS) \
	PROVIDED_VNDK_VERSIONS="$(PLATFORM_VNDK_VERSION) $(PRODUCT_EXTRA_VNDK_VERSIONS)" \
