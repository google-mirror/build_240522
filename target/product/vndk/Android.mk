...
vndk_major_vers := 10000
vndk_minor_vers := 0

#TODO(jiyong): Revive this check when we have stable VNDK in P or later.
#ifneq ($(vndk_major_vers), $(PLATFORM_SDK_VERSION))
...
PLATFORM_VNDK_VERSION := $(join $(addsuffix .,$(vndk_major_vers)), $(vndk_minor_vers))
vndk_major_vers :=
vndk_minor_vers :=
