...
PRODUCT_BOOT_JARS := \
    $(ART_APEX_JARS) \
    system:framework-minus-apex \
    system:ext \
    system:telephony-common \
    system:voip-common \
    system:ims-common \
...
PRODUCT_BOOT_JARS += system:framework-atb-backward-compatibility
else
PRODUCT_BOOT_JARS += system:android.test.base
endif
