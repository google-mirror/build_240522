...
$(check-vndk-abi-dump-list-timestamp):
	...
	$(if $(added_platform_abi_dumps), \
	  echo -e "Found ABI reference dumps for non-PLATFORM libraries. Run \`find \$${ANDROID_BUILD_TOP}/$(PLATFORM_ABI_DUMP_DIR) '(' -name $(subst $(space), -or -name ,$(added_platform_abi_dumps)) ')' -delete\` to delete the dumps.")
