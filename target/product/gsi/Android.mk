...
# VNDK will not be frozen if the PLATFORM_VNDK_VERSION is a codename or greater
# than 34
ifeq ($(if $(call math_is_number,$(PLATFORM_VNDK_VERSION)),$(call math_gt_or_eq,34,$(PLATFORM_VNDK_VERSION))),)
UNFROZEN_VNDK := true
endif
