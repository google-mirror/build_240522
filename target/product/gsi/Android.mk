...
$(INTERNAL_VNDK_LIB_LIST):
	...
	$(hide) $(foreach lib, $(llndk_libraries), \
	  echo LLNDK: $(lib) >> $@;)
	$(hide) $(foreach lib, $(vndk_sp_libraries), \
	  echo VNDK-SP: $(lib) >> $@;)
