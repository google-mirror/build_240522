...
PRODUCT_SYSTEM_PROPERTIES += \
    ...
    pm.dexopt.install-bulk-critical?=speed-profile \
    pm.dexopt.install-bulk-non-critical?=verify \
    pm.dexopt.install-bulk-critical-downgraded?=verify \
    pm.dexopt.install-bulk-non-critical-downgraded?=skip \
    pm.dexopt.install-bulk-non-critical-upgraded?=speed-profile \
