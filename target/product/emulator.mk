...
PRODUCT_COPY_FILES += \
    ...
    device/generic/goldfish/fstab.ranchu.early:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.ranchu.early \
...
# Retain classes.dex in APK's (non-user builds or not) since the system.img
# built for the emulator is going to used as (non-A/B) GSI.
