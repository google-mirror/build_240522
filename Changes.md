...
Soong_UI will handle BUILD_NUMBER and generate a txt file containing the proper
value. So in Make side, please use BUILD_NUMBER_FROM_FILE instead.

### Stop using BUILD_DATETIME {#BUILD_DATETIME}

Soong_UI will handle BUILD_DATETIME and generate a txt file containing the proper
